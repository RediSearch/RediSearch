...
description: Determine which parts of the C codebase use Rust-defined C symbols. Use this when you want to understand the impact of changes to a Rust FFI crate.
---
