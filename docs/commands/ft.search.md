...
- **query**: the text query to search. If it's more than a single word, put it in quotes.
  Refer to [query syntax](/docs/stack/search/reference/query_syntax) for more details.
...
- **SUMMARIZE ...**: Use this option to return only the sections of the attribute which contain the
  matched text.
  See [Highlighting](/docs/stack/search/reference/highlight) for more details
- **HIGHLIGHT ...**: Use this option to format occurrences of matched text. See [Highlighting](/docs/stack/search/reference/highlight) for more
  details
...
- **EXPANDER {expander}**: If set, we will use a custom query expander instead of the stemmer. [See Extensions](/docs/stack/search/reference/extensions).
- **SCORER {scorer}**: If set, we will use a custom scoring function defined by the user. [See Extensions](/docs/stack/search/reference/extensions).
...
- **PAYLOAD {payload}**: Add an arbitrary, binary safe payload that will be exposed to custom scoring
  functions. [See Extensions](/docs/stack/search/reference/extensions).
