...
Runs a search query on an index, and performs aggregate transformations on the results, extracting statistics etc from them. See [the full documentation on aggregations](/docs/stack/search/reference/aggregations) for further details.
...
!!! tip "More examples"
    For more details on aggregations and detailed examples of aggregation queries, see [aggregations](/docs/stack/search/reference/aggregations).
