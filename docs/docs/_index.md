...
* [Vector similarity search](https://redis.io/docs/stack/search/reference/query_syntax/#vector-similarity-search-in-query) for sematic search using exact and approximate algorithms
