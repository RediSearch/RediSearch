...
**NOTE:** Stop words are words that are so common that a search engine ignores them. We have a dedicated page about [stop words in RediSearch](/docs/stack/search/reference/stopwords) if you would like to learn more.
