...
**NOTE:** Stop words are words that are so common that a search engine ignores them. We have a dedicated page about [stop words in Search and Query](/redisearch/reference/stopwords) if you would like to learn more.
