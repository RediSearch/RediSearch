...
static inline void *rm_malloc(size_t n) { return RedisModule_Alloc(n); }
...
static inline void rm_free(void *p) { RedisModule_Free(p); }
static inline char *rm_strdup(const char *s) { return RedisModule_Strdup(s); }
