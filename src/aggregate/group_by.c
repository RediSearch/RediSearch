 ...
 */
static void extractGroups(Grouper *g, const RSValue **xarr, size_t xpos, size_t xlen, uint64_t hval,
                          RLookupRow *res) {
...
void Grouper_Free(Grouper *g) { g->base.Free(&g->base); }
...
ResultProcessor *Grouper_GetRP(Grouper *g) { return &g->base; }
