...
Reducer *RDCRMin_New(const ReducerOptions *options) { return newMinMax(options, minAdd); }

Reducer *RDCRMax_New(const ReducerOptions *options) { return newMinMax(options, maxAdd); }
