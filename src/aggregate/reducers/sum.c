...
Reducer *RDCRSum_New(const ReducerOptions *options) { return newReducerCommon(options, 0); }

Reducer *RDCRAvg_New(const ReducerOptions *options) { return newReducerCommon(options, 1); }
