...
int AGPLN_HasStep(const AGGPlan *pln, PLN_StepType t) { return (pln->steptypes & (1 << (t - 1))); }
...
static RLookup *rootStepLookup(PLN_BaseStep *bstp) { return &((PLN_FirstStep *)bstp)->lookup; }
