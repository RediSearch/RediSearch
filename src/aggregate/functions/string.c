...
static int stringfunc_startswith(ExprEval *ctx, RSValue *result, RSValue **argv, size_t argc,
                                 QueryError *err) {
...
static int stringfunc_contains(ExprEval *ctx, RSValue *result, RSValue **argv, size_t argc,
                               QueryError *err) {
...
static int stringfunc_strlen(ExprEval *ctx, RSValue *result, RSValue **argv, size_t argc,
                             QueryError *err) {
