...
static const YYCODETYPE yyRuleInfoLhs[] = {
    26, /* (0) program ::= expr */
    27, /* (1) expr ::= LP expr RP */
    27, /* (2) expr ::= expr PLUS expr */
    27, /* (3) expr ::= expr DIVIDE expr */
    27, /* (4) expr ::= expr TIMES expr */
    27, /* (5) expr ::= expr MINUS expr */
    27, /* (6) expr ::= expr POW expr */
    27, /* (7) expr ::= expr MOD expr */
    27, /* (8) expr ::= expr EQ expr */
    27, /* (9) expr ::= expr NE expr */
    27, /* (10) expr ::= expr LT expr */
    27, /* (11) expr ::= expr LE expr */
    27, /* (12) expr ::= expr GT expr */
    27, /* (13) expr ::= expr GE expr */
    27, /* (14) expr ::= expr AND expr */
    27, /* (15) expr ::= expr OR expr */
    27, /* (16) expr ::= NOT expr */
    27, /* (17) expr ::= STRING */
    27, /* (18) expr ::= number */
    24, /* (19) number ::= NUMBER */
    24, /* (20) number ::= MINUS NUMBER */
    27, /* (21) expr ::= PROPERTY */
    27, /* (22) expr ::= SYMBOL LP arglist RP */
    27, /* (23) expr ::= SYMBOL */
    25, /* (24) arglist ::= */
    25, /* (25) arglist ::= expr */
    25, /* (26) arglist ::= arglist COMMA expr */
};
...
static const signed char yyRuleInfoNRhs[] = {
    ...
    -3, /* (8) expr ::= expr EQ expr */
    -3, /* (9) expr ::= expr NE expr */
    -3, /* (10) expr ::= expr LT expr */
    -3, /* (11) expr ::= expr LE expr */
    -3, /* (12) expr ::= expr GT expr */
    -3, /* (13) expr ::= expr GE expr */
    ...
    -1, /* (18) expr ::= number */
    -1, /* (19) number ::= NUMBER */
    -2, /* (20) number ::= MINUS NUMBER */
    -1, /* (21) expr ::= PROPERTY */
    -4, /* (22) expr ::= SYMBOL LP arglist RP */
    -1, /* (23) expr ::= SYMBOL */
    0,  /* (24) arglist ::= */
    -1, /* (25) arglist ::= expr */
    -3, /* (26) arglist ::= arglist COMMA expr */
};
...
yy_reduce(yyParser *yypParser,                         /* The parser */
    ...
    {
        yylhsminor.yy19 =
            RS_NewPredicate(RSCondition_Eq, yymsp[-2].minor.yy19, yymsp[0].minor.yy19);
    }
        yymsp[-2].minor.yy19 = yylhsminor.yy19;
        break;
    ...
    {
        yylhsminor.yy19 =
            RS_NewPredicate(RSCondition_Ne, yymsp[-2].minor.yy19, yymsp[0].minor.yy19);
    }
        yymsp[-2].minor.yy19 = yylhsminor.yy19;
        break;
    ...
    {
        yylhsminor.yy19 =
            RS_NewPredicate(RSCondition_Lt, yymsp[-2].minor.yy19, yymsp[0].minor.yy19);
    }
        yymsp[-2].minor.yy19 = yylhsminor.yy19;
        break;
    ...
    {
        yylhsminor.yy19 =
            RS_NewPredicate(RSCondition_Le, yymsp[-2].minor.yy19, yymsp[0].minor.yy19);
    }
        yymsp[-2].minor.yy19 = yylhsminor.yy19;
        break;
    ...
    {
        yylhsminor.yy19 =
            RS_NewPredicate(RSCondition_Gt, yymsp[-2].minor.yy19, yymsp[0].minor.yy19);
    }
        yymsp[-2].minor.yy19 = yylhsminor.yy19;
        break;
    ...
    {
        yylhsminor.yy19 =
            RS_NewPredicate(RSCondition_Ge, yymsp[-2].minor.yy19, yymsp[0].minor.yy19);
    }
        yymsp[-2].minor.yy19 = yylhsminor.yy19;
        break;
    ...
    {
        yylhsminor.yy19 =
            RS_NewPredicate(RSCondition_And, yymsp[-2].minor.yy19, yymsp[0].minor.yy19);
    }
        yymsp[-2].minor.yy19 = yylhsminor.yy19;
        break;
    ...
    {
        yylhsminor.yy19 =
            RS_NewPredicate(RSCondition_Or, yymsp[-2].minor.yy19, yymsp[0].minor.yy19);
    }
        yymsp[-2].minor.yy19 = yylhsminor.yy19;
        break;
    ...
    case 22: /* expr ::= SYMBOL LP arglist RP */
    {
        ...
        if (!cb) {
            ...
            yylhsminor.yy19 = RS_NewFunc(yymsp[-3].minor.yy0.s, yymsp[-3].minor.yy0.len,
                                         yymsp[-1].minor.yy46, cb);
        }
    }
...
#define TOKEN yyminor
        ...
        rm_asprintf(&ctx->errorMsg, "Syntax error at offset %d near '%.*s': %s", TOKEN.pos,
                    TOKEN.len, TOKEN.s, reason);
        rm_free(reason);
    }
    else {
