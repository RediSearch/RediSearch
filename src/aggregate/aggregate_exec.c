 ...
 *
 * Multi-shard coordinator reads do not come through here (any policy):
 * CursorCommand parses and takes the cursor on the main thread and dispatches
 * a coordCursorRead_ctx job via RSCursorReadDispatchTaken.
 */
