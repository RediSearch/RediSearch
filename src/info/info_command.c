...
void fillReplyWithIndexInfo(RedisSearchCtx* sctx, RedisModule_Reply *reply, bool obfuscate, bool withTimes) {
  ...
  // key_table_size_mb is no longer tracked since DocIdMap was removed
  REPLY_KVNUM("key_table_size_mb", 0.0);
  ...
  REPLY_KVNUM("total_index_memory_sz_mb", IndexSpec_TotalMemUsage(specForOpeningIndexes, 0,
