...
// range branch of NewVectorIterator and by unit tests. A NULL timeout selects iterator-owned
// UNARMED state for requestless callers. See the definition for ownership details.
