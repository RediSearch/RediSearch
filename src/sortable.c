 ...
 * TODO: Remove this if the unicode normalization / case-folding is in Rust. MOD-10320
 */
...
/* Load a sorting vector from RDB. Used by legacy RDB load only, todo rewrite in MOD-10547 */
