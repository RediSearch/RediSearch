...
static const YYCODETYPE yy_lookahead[] = {
 ...
 /*   270 */    42,   42,   42,   42,   42,   42,   42,   42,   42,   27,
 /*   280 */    27,   27,   27,   27,   27,
};
...
{
    yymsp[-3].minor.yy36 = NewNumericFilter(yymsp[-2].minor.yy83.num, yymsp[-1].minor.yy83.num, yymsp[-2].minor.yy83.dec, yymsp[-1].minor.yy83.dec, yymsp[-2].minor.yy83.inclusive, yymsp[-1].minor.yy83.inclusive);
}
        break;
      ...
      case 49: /* num ::= NUMBER */
{
    ...
    yylhsminor.yy83.dec = yymsp[0].minor.yy0.decval;
