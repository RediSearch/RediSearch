...
{
  yymsp[-3].minor.yy50 = NewQueryParam(QP_NUMERIC_FILTER);
  yymsp[-3].minor.yy50->nf = NewNumericFilter(yymsp[-2].minor.yy83.num, yymsp[-1].minor.yy83.num, yymsp[-2].minor.yy83.inclusive, yymsp[-1].minor.yy83.inclusive);
}
        break;
