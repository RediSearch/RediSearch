...
void *RSQueryParser_v1_Alloc(void *(*mallocProc)(YYMALLOCARGTYPE)RSQueryParser_v1_CTX_PDECL) {
    ...
    if (yypParser) {
        RSQueryParser_v1_CTX_STORE RSQueryParser_v1_Init(yypParser RSQueryParser_v1_CTX_PARAM);
    }
...
static void yy_destructor(yyParser *yypParser,  /* The parser */
    ...
    RSQueryParser_v1_ARG_FETCH RSQueryParser_v1_CTX_FETCH switch (yymajor) {
...
*/
void RSQueryParser_v1_Free(void *p,                 /* The parser to be deleted */
...
static void yyStackOverflow(yyParser *yypParser) {
    RSQueryParser_v1_ARG_FETCH RSQueryParser_v1_CTX_FETCH
#ifndef NDEBUG
        if (yyTraceFILE) {
...
yy_reduce(yyParser *yypParser,                        /* The parser */
    ...
    RSQueryParser_v1_ARG_FETCH(void) yyLookahead;
    ...
    case 3: /* expr ::= expr expr */
    {
        ...
        if (rv == NODENN_BOTH_INVALID) {
            ...
            if (yymsp[-1].minor.yy75 && yymsp[-1].minor.yy75->type == QN_PHRASE &&
                yymsp[-1].minor.yy75->pn.exact == 0 &&
    ...
    case 5: /* union ::= expr OR expr */
    {
        ...
        if (rv == NODENN_BOTH_INVALID) {
            ...
            if (yymsp[-2].minor.yy75->type == QN_UNION &&
                yymsp[-2].minor.yy75->opts.fieldMask == RS_FIELDMASK_ALL) {
    ...
    case 7: /* expr ::= modifier COLON expr */
    {
        if (yymsp[0].minor.yy75 == NULL) {
            ...
            if (ctx->sctx->spec) {
                QueryNode_SetFieldMask(yymsp[0].minor.yy75,
    ...
    {
        yylhsminor.yy87 =
            (QueryAttribute){.name = yymsp[-2].minor.yy0.s,
                             .namelen = yymsp[-2].minor.yy0.len,
                             .value = rm_strndup(yymsp[0].minor.yy0.s, yymsp[0].minor.yy0.len),
    ...
    case 15: /* expr ::= expr ARROW LB attribute_list RB */
    {
        ...
        if (yymsp[-4].minor.yy75 && yymsp[-1].minor.yy1) {
            QueryNode_ApplyAttributes(yymsp[-4].minor.yy75, yymsp[-1].minor.yy1,
                                      array_len(yymsp[-1].minor.yy1), ctx->status);
        }
    ...
    case 33: /* expr ::= PERCENT STOPWORD PERCENT */
    ...
    case 34: /* expr ::= PERCENT PERCENT STOPWORD PERCENT PERCENT */
    ...
    case 35: /* expr ::= PERCENT PERCENT PERCENT STOPWORD PERCENT PERCENT PERCENT */
    ...
    case 39: /* expr ::= modifier COLON tag_list */
    {
        if (!yymsp[0].minor.yy75) {
            ...
            QueryNode_AddChildren(yylhsminor.yy75, yymsp[0].minor.yy75->children,
                                  QueryNode_NumChildren(yymsp[0].minor.yy75));

            // Set the children count on yymsp[0].minor.yy75 to 0 so they won't get recursively
            // free'd
    ...
    case 41: /* tag_list ::= LB STOPWORD */
        yytestcase(yyruleno == 41);
        {
            yymsp[-1].minor.yy75 = NewPhraseNode(0);
            QueryNode_AddChild(
                yymsp[-1].minor.yy75,
                NewTokenNode(ctx, rm_strndup(yymsp[0].minor.yy0.s, yymsp[0].minor.yy0.len), -1));
        }
        break;
    case 42: /* tag_list ::= LB affix */
    case 43: /* tag_list ::= LB termlist */
    ...
    case 49: /* expr ::= modifier COLON numeric_range */
    {
        ...
        yymsp[0].minor.yy62->nf->fieldName =
    ...
    case 50: /* numeric_range ::= LSQB num num RSQB */
    {
        ...
        yymsp[-3].minor.yy62->nf =
            NewNumericFilter(yymsp[-2].minor.yy47.num, yymsp[-1].minor.yy47.num,
                             yymsp[-2].minor.yy47.inclusive, yymsp[-1].minor.yy47.inclusive, true);
    } break;
    case 51: /* expr ::= modifier COLON geo_filter */
    {
        // we keep the capitalization as is
        yymsp[0].minor.yy62->gf->property =
            rm_strndup(yymsp[-2].minor.yy0.s, yymsp[-2].minor.yy0.len);
    ...
    case 52: /* geo_filter ::= LSQB num num num TERM RSQB */
    {
        ...
        yymsp[-5].minor.yy62->gf =
            NewGeoFilter(yymsp[-4].minor.yy47.num, yymsp[-3].minor.yy47.num,
                         yymsp[-2].minor.yy47.num, yymsp[-1].minor.yy0.s, yymsp[-1].minor.yy0.len);
...
** None.
*/
void RSQueryParser_v1_(void *yyp,                         /* The parser */
    ...
    RSQueryParser_v1_CTX_FETCH RSQueryParser_v1_ARG_STORE
