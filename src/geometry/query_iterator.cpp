...
auto QueryIterator::base() noexcept -> IndexIterator * { return &base_; }
...
t_docId QueryIterator::current() const noexcept { return base_.current->docId; }
int QueryIterator::has_next() const noexcept { return index_ < len(); }
std::size_t QueryIterator::len() const noexcept { return iter_.size(); }
void QueryIterator::abort() noexcept { base_.isValid = false; }
...
t_docId QIter_LastDocId(void *ctx) { return static_cast<QueryIterator const *>(ctx)->current(); }
int QIter_HasNext(void *ctx) { return static_cast<QueryIterator const *>(ctx)->has_next(); }
...
std::size_t QIter_Len(void *ctx) { return static_cast<QueryIterator const *>(ctx)->len(); }
void QIter_Abort(void *ctx) { static_cast<QueryIterator *>(ctx)->abort(); }
void QIter_Rewind(void *ctx) { static_cast<QueryIterator *>(ctx)->rewind(); }
} // anonymous namespace
