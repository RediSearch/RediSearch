...
// ===== impl RLookupKeyHeader ====

impl<'a> RLookupKeyHeader<'a> {
    /// Access the name of the RLookupKey as &CStr refereence
    pub const fn name_as_cstr(&self) -> &CStr {
        // Safety: RLookupKeyHeader is only generated by RLookupKey::new()
        // which takes a Cow to a CStr and by this ensures that self.name
        // points to a valid null-terminated string for the lifetime of the
        // RLookupKeyHeader.
