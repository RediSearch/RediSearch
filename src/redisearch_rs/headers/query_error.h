...
enum QueryErrorCode
...
#endif // __cplusplus
 {
  ...
  QUERY_ERROR_CODE_FLEX_UNSUPPORTED_FIELD_OPTION,
  ...
  QUERY_ERROR_CODE_FLEX_SEARCH_SLOP_UNSUPPORTED,
  QUERY_ERROR_CODE_FLEX_SEARCH_INORDER_UNSUPPORTED,
  QUERY_ERROR_CODE_FLEX_SEARCH_HIGHLIGHT_UNSUPPORTED,
  QUERY_ERROR_CODE_FLEX_SEARCH_SUMMARIZE_UNSUPPORTED,
  QUERY_ERROR_CODE_FLEX_SEARCH_SCORER_TFIDF_UNSUPPORTED,
  QUERY_ERROR_CODE_FLEX_SEARCH_SCORER_TFIDF_DOCNORM_UNSUPPORTED,
  QUERY_ERROR_CODE_FLEX_SEARCH_SCORER_BM25_UNSUPPORTED,
};
#ifndef __cplusplus
