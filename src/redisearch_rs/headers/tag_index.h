 ...
 * TODO
 */
uint32_t TagIndex2_Commit(struct TagIndex *tag_index, const char *const *values, size_t n);
 ...
 * TODO
 */
struct TagIndexWriteResult TagIndex2_Index(struct TagIndex *tag_index, const struct RedisModuleCtx *ctx, const SearchDiskWriteBatchHandle *batch, const char *const *values, size_t n, t_docId doc_id, bool has_field_expiration);
