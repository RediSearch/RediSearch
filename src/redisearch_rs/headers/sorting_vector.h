...
/* WARNING: this file was auto-generated by cheadergen from `sorting_vector`. Do not edit it manually. */
...
#ifndef THINVEC_SHAREDVALUE__U64_DEFINED
#define THINVEC_SHAREDVALUE__U64_DEFINED
/**
 * See the crate's top level documentation for a description of this type.
 */
typedef struct ThinVec_SharedValue__u64 {
  struct Header_u64 *ptr;
} ThinVec_SharedValue__u64;
#endif /* THINVEC_SHAREDVALUE__U64_DEFINED */
