 ...
 */
struct SpellCheckDictionary *SpellCheckDictionary_RdbLoad(struct RedisModuleIO *io);
 ...
 */
void SpellCheckDictionary_RdbSave(struct RedisModuleIO *io, const struct SpellCheckDictionary *dict);
