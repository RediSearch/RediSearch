 ...
 */
struct TagIndexWriteResult Rust_TagIndex_Index(struct RustTagIndex *tag_index, const struct RedisModuleCtx *ctx, const SearchDiskWriteBatchHandle *batch, const char *const *values, size_t n, t_docId doc_id, bool has_field_expiration);
 ...
 */
QueryIterator *Rust_TagIndex_OpenReader(const struct RustTagIndex *tag_index, RedisSearchCtx *sctx, const char *value, size_t len, double weight, t_fieldIndex field_index, QueryError *status);
