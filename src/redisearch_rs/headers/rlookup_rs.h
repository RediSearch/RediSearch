...
typedef void RSValue;

#ifdef __cplusplus
extern "C" {
#endif // __cplusplus

void RLookup_WriteKey(const struct RLookupKey *key, struct RLookupRow *row, RSValue value);

void RLookupRow_WriteOwnKey(const struct RLookupKey *key, struct RLookupRow *row, RSValue value);
 ...
 */
void RLookupRow_Wipe(struct RLookupRow *vec);
 ...
 * 1. The pointer must be a valid pointer to an [`RLookupRow`].
 */
void RLookupRow_Cleanup(struct RLookupRow *vec);
