 ...
 */
QueryIterator *NewMetricIteratorSortedById(t_docId *ids, double *metric_list, uintptr_t num, enum MetricType type_);
 ...
 *    so the caller must ensure that these pointers were allocated in a compatible manner.
 */
QueryIterator *NewMetricIteratorSortedByScore(t_docId *ids, double *metric_list, uintptr_t num, enum MetricType type_);
 ...
 */
QueryIterator *NewIntersectionIterator(QueryIterator * *its, uintptr_t num, int32_t max_slop, bool in_order, double weight);
 ...
 */
uintptr_t GetIntersectionIteratorNumChildren(const QueryIterator *header);
 ...
 */
const QueryIterator *GetIntersectionIteratorChild(const QueryIterator *header, uintptr_t idx);
 ...
 */
QueryIterator *NewInvIndIterator_NumericQuery(const struct NumericIndex *idx, const RedisSearchCtx *sctx, const struct FieldFilterContext *field_ctx, const struct NumericFilter *flt, const struct NumericRangeTree *rt, double range_min, double range_max);
 ...
 */
const char *InvIndMissingIterator_GetFieldName(const QueryIterator *it, uintptr_t *out_len);
 ...
 */
struct NumericRangeIteratorsResult CreateNumericRangeIterators(const struct NumericRangeTree *t, const RedisSearchCtx *sctx, const struct NumericFilter *f, const struct FieldFilterContext *field_ctx);
