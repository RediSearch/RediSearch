...
use rqe_iterators::{
    Empty, IteratorType, RQEIterator, TypeErasedRQEIterator, Wildcard,
...
fn single_non_empty_after_filtering_reduces_to_single() {
    let children: Vec<TypeErasedRQEIterator<'static>> = vec![
        ...
        TypeErasedRQEIterator::new(Box::new(Mock::new([5, 10]))),
        TypeErasedRQEIterator::new(Box::new(Empty)),
    ];
    let result = new_union_iterator(children, false, 20);
...
fn quick_exit_wildcard_reduces_to_single() {
    let children: Vec<TypeErasedRQEIterator<'static>> = vec![
        TypeErasedRQEIterator::new(Box::new(Mock::new([1, 2]))),
        TypeErasedRQEIterator::new(Box::new(Wildcard::new(10, 1.0))),
        TypeErasedRQEIterator::new(Box::new(Mock::new([3, 4]))),
    ];
...
fn flat_selected_when_at_threshold() {
    ...
    let children: Vec<TypeErasedRQEIterator<'static>> = vec![
        TypeErasedRQEIterator::new(Box::new(Mock::new([1, 3]))),
        TypeErasedRQEIterator::new(Box::new(Mock::new([2, 4]))),
    ];
...
fn heap_selected_when_above_threshold() {
    ...
    let children: Vec<TypeErasedRQEIterator<'static>> = vec![
        TypeErasedRQEIterator::new(Box::new(Mock::new([1, 4]))),
        TypeErasedRQEIterator::new(Box::new(Mock::new([2, 5]))),
        TypeErasedRQEIterator::new(Box::new(Mock::new([3, 6]))),
    ];
    let result = new_union_iterator(children, false, 2);
...
fn flat_union_produces_all_docs() {
    let children: Vec<TypeErasedRQEIterator<'static>> = vec![
        TypeErasedRQEIterator::new(Box::new(Mock::new([1, 3, 5]))),
        TypeErasedRQEIterator::new(Box::new(Mock::new([2, 3, 4]))),
    ];
    let result = new_union_iterator(children, false, 20);
...
fn heap_union_produces_all_docs() {
    let children: Vec<TypeErasedRQEIterator<'static>> = vec![
        TypeErasedRQEIterator::new(Box::new(Mock::new([1, 4, 7]))),
        TypeErasedRQEIterator::new(Box::new(Mock::new([2, 5, 8]))),
        TypeErasedRQEIterator::new(Box::new(Mock::new([3, 6, 9]))),
    ];
    let result = new_union_iterator(children, false, 2);
