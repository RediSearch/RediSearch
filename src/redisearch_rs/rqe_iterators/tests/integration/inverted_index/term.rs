...
use inverted_index::{
    FilterMaskReader, RSIndexResult, RSOffsetSlice, full::Full, opaque::OpaqueEncoding,
};
...
mod not_miri {
    ...
    ///
    /// Driven bare: this branch has no `ContractChecker`, which master's version of this test
    ...
    fn appended_record(doc_id: t_docId) -> RSIndexResult<'static> {
