...
impl<'query, Rf: Ref, E: DecodedBy, C> RawMissing<'query, Rf, E, C> {
...
impl<'query, Rf: Ref, E, C> RawMissing<'query, Rf, E, C>
where
...
impl<'query, E, C> RQESuspendedIterator<'query> for RawMissing<'query, Suspended, E, C>
where
    E: DecodedBy + OpaqueEncoding<Storage = inverted_index::InvertedIndex<E>> + 'static,
    <E as DecodedBy>::Decoder: DocIdsDecoder,
    C: ExpirationChecker + 'static,
