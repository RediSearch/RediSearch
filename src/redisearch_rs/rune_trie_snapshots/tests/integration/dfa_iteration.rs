...
use ffi::{
    NewTrie, RSPayload, Trie, Trie_InsertStringBuffer, Trie_Iterate, Trie_Size, TrieIterator_Free,
...
/// Same shape as the helper in `insert_iterate.rs`.
...
/// Insert a UTF-8 term into a Lex-mode trie with no payload.
