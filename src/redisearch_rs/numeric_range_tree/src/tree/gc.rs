...
impl NumericRangeTree {
    ...
    pub fn compact_if_sparse(&mut self) -> usize {
        ...
        if self.stats.empty_leaves == 0 || self.stats.empty_leaves < self.stats.num_leaves / 2 {
            return 0;
        }
    ...
    fn compact_slab(&mut self) -> usize {
        ...
        let n_holes = cap_before - self.nodes.len();
        ...
        std::mem::size_of::<NumericRangeNode>() * (slots_freed as usize)
    }
