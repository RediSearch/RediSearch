...
//! ## Balancing
//!
//! The tree uses AVL-like rotations to maintain balance. To simplify rebalancing,
//! we do not rebalance nodes that still retain their ranges.
//!
//! ## Concurrency
//!
...
pub use node::{InternalNode, LeafNode, NodeIndex, NumericRangeNode};
