...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn RSValue_IsRedisString(value: *const RsValue) -> bool {
    unimplemented!("RSValue_IsRedisString")
}
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn RSValue_IsAnyString(value: *const RsValue) -> bool {
    unimplemented!("RSValue_IsAnyString")
}
