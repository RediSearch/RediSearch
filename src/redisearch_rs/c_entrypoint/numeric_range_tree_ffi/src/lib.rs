...
pub use inverted_index_ffi::{
    IndexRepairParams,
    fork_gc::{InvertedIndexGCCallback, InvertedIndexGCWriter},
};
...
// HyperLogLog constants for cardinality estimation.
// These match the Rust HyperLogLog6 type used in NumericRange.

/// HyperLogLog bit precision (6 bits = 64 registers).
pub const NR_BIT_PRECISION: usize = 6;

/// Number of HyperLogLog registers (2^6 = 64).
pub const NR_REG_SIZE: usize = 64;
