...
/// Extract the panic payload as a string, if possible.
fn get_panic_payload_str(panic_info: &std::panic::PanicHookInfo<'_>) -> Option<String> {
...
pub extern "C" fn RustPanicHook_Init() {
    ...
    std::panic::set_hook(Box::new(move |panic_info| {
        ...
        tracing::error!(
            panic.payload = get_panic_payload_str(panic_info),
