...
/// # Safety
///
/// 1. `lookup` must be a [valid] pointer to a `RLookup`
...
/// [valid]: https://doc.rust-lang.org/std/ptr/index.html#safety
#[unsafe(no_mangle)]
pub extern "C" fn RLookup_GetKey_ReadEx<'a>(
    lookup: Option<NonNull<RLookup<'a>>>,
    name: *const c_char,
    name_len: size_t,
    flags: u32,
    ...
    // Safety: ensured by caller (2., 3., 4., 5.)
    let name = unsafe {
        let bytes = slice::from_raw_parts(name.cast::<u8>(), name_len);
...
/// [valid]: https://doc.rust-lang.org/std/ptr/index.html#safety
#[unsafe(no_mangle)]
pub extern "C" fn RLookup_GetKey_Write<'a>(
    lookup: Option<NonNull<RLookup<'a>>>,
    name: *const c_char,
    flags: u32,
) -> Option<NonNull<RLookupKey<'a>>> {
...
/// [valid]: https://doc.rust-lang.org/std/ptr/index.html#safety
#[unsafe(no_mangle)]
pub extern "C" fn RLookup_GetKey_WriteEx<'a>(
    lookup: Option<NonNull<RLookup<'a>>>,
    name: *const c_char,
    name_len: size_t,
    flags: u32,
...
/// [valid]: https://doc.rust-lang.org/std/ptr/index.html#safety
#[unsafe(no_mangle)]
pub extern "C" fn RLookup_GetKey_Load<'a>(
    lookup: Option<NonNull<RLookup<'a>>>,
    name: *const c_char,
...
/// [valid]: https://doc.rust-lang.org/std/ptr/index.html#safety
#[unsafe(no_mangle)]
pub extern "C" fn RLookup_GetKey_LoadEx<'a>(
    lookup: Option<NonNull<RLookup<'a>>>,
    name: *const c_char,
    name_len: size_t,
    field_name: *const c_char,
