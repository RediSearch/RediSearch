...
#[unsafe(no_mangle)]
extern "C" fn RSValue_IncrRef(v: *mut ffi::RSValue) -> *mut ffi::RSValue {
...
#[unsafe(no_mangle)]
extern "C" fn RSValue_DecrRef(v: *mut ffi::RSValue) {
...
#[unsafe(no_mangle)]
extern "C" fn RSValue_Refcount(v: *mut ffi::RSValue) -> u16 {
