...
//!   that turns a parsed [`WildcardPattern`](rqe_wildcard::WildcardPattern)
//!   into a flat atom slice.
...
//! matching is a separate automaton:
//! [`CodepointWildcard`](super::CodepointWildcard).
