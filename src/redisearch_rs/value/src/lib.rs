...
// TODO: optimize memory size to make this at most 16 bytes big
#[derive(Debug, Clone)]
...
pub trait Value: Sized {
    ...
    unsafe fn rm_alloc_string(str: NonNull<c_char>, len: u32) -> Self {
    ...
    ///
    /// # Safety
    /// See [`RedisStringRef::new_unchecked(str)`]
