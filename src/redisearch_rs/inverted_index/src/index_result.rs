...
impl RSResultData<'_> {
    ...
    pub fn deep_copy(&self) -> RSResultData<'static> {
        match self {
            ...
            Self::Virtual(_) => RSResultData::Virtual(RSVirtualResult),
            Self::Numeric(num) => RSResultData::Numeric(RSNumericRecord(num.0)),
            Self::Metric(num) => RSResultData::Metric(RSNumericRecord(num.0)),
