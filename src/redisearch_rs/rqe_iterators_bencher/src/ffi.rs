...
impl QueryIterator {
    ...
    #[inline(always)]
    pub fn new_numeric_full(ii: *mut bindings::InvertedIndex) -> Self {
        Self(unsafe { bindings::NewInvIndIterator_NumericFull(ii) })
    }

    #[inline(always)]
    pub fn new_term_full(ii: *mut bindings::InvertedIndex) -> Self {
...
impl InvertedIndex {
    ...
    pub fn iterator_numeric_full(&self) -> QueryIterator {
        QueryIterator::new_numeric_full(self.0)
    }

    #[inline(always)]
    pub fn iterator_term_full(&self) -> QueryIterator {
        QueryIterator::new_term_full(self.0)
    }
}
...
mod tests {
    ...
    fn numeric_full_iterator() {
        ...
        let it = QueryIterator::new_numeric_full(ii.0);
    ...
    fn term_full_iterator() {
        ...
        let it = QueryIterator::new_term_full(ii.0);
        assert_eq!(it.num_estimated(), 3);
