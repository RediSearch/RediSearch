...
static int r_Prefix_Step1(struct SN_env * z) { /* forwardmode */
    ...
    z->bra = z->c; /* [, line 373 */
    if (z->c + 3 >= z->l || z->p[z->c + 3] >> 5 != 5 || !((188 >> (z->p[z->c + 3] & 0x1f)) & 1)) return 0; /* substring, line 373 */
    ...
    switch (among_var) { /* among, line 373 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 374 */
            {   int ret = slice_from_s(z, 2, s_56); /* <-, line 374 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 375 */
            {   int ret = slice_from_s(z, 2, s_57); /* <-, line 375 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 376 */
            {   int ret = slice_from_s(z, 2, s_58); /* <-, line 376 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 377 */
            {   int ret = slice_from_s(z, 2, s_59); /* <-, line 377 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 378 */
            {   int ret = slice_from_s(z, 2, s_60); /* <-, line 378 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Prefix_Step2(struct SN_env * z) { /* forwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 384 */
    {   int c1 = z->c; /* not, line 385 */
        if (!(eq_s(z, 4, s_61))) goto lab0; /* literal, line 385 */
        return 0;
    lab0:
        z->c = c1;
    }
    {   int c2 = z->c; /* not, line 386 */
        if (!(eq_s(z, 4, s_62))) goto lab1; /* literal, line 386 */
        return 0;
    lab1:
        z->c = c2;
    }
    z->bra = z->c; /* [, line 387 */
    if (z->c + 1 >= z->l || (z->p[z->c + 1] != 129 && z->p[z->c + 1] != 136)) return 0; /* substring, line 387 */
    among_var = find_among(z, a_5, 2);
    if (!(among_var)) return 0;
    z->ket = z->c; /* ], line 387 */
    switch (among_var) { /* among, line 387 */
        case 0: return 0;
        case 1:
        ...
        case 2:
            ...
            {   int ret = slice_del(z); /* delete, line 389 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Prefix_Step3a_Noun(struct SN_env * z) { /* forwardmode */
    ...
    z->bra = z->c; /* [, line 395 */
    if (z->c + 3 >= z->l || (z->p[z->c + 3] != 132 && z->p[z->c + 3] != 167)) return 0; /* substring, line 395 */
    ...
    switch (among_var) { /* among, line 395 */
        ...
        case 1:
            ...
            break;
        case 2:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 397 */
...
static int r_Prefix_Step3b_Noun(struct SN_env * z) { /* forwardmode */
    ...
    z->bra = z->c; /* [, line 404 */
    if (z->c + 1 >= z->l || (z->p[z->c + 1] != 168 && z->p[z->c + 1] != 131)) return 0; /* substring, line 404 */
    among_var = find_among(z, a_7, 3);
    if (!(among_var)) return 0;
    z->ket = z->c; /* ], line 404 */
    switch (among_var) { /* among, line 404 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 405 */
            {   int ret = slice_del(z); /* delete, line 405 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 407 */
            {   int ret = slice_from_s(z, 2, s_64); /* <-, line 407 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            if (!(z->I[0] > 3)) return 0; /* $word_len > <integer expression>, line 408 */
            {   int ret = slice_from_s(z, 2, s_65); /* <-, line 408 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Prefix_Step3_Verb(struct SN_env * z) { /* forwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 414 */
    z->bra = z->c; /* [, line 415 */
    among_var = find_among(z, a_8, 4); /* substring, line 415 */
    if (!(among_var)) return 0;
    z->ket = z->c; /* ], line 415 */
    switch (among_var) { /* among, line 415 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 417 */
            {   int ret = slice_from_s(z, 2, s_66); /* <-, line 417 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 418 */
            {   int ret = slice_from_s(z, 2, s_67); /* <-, line 418 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 419 */
            {   int ret = slice_from_s(z, 2, s_68); /* <-, line 419 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 420 */
            {   int ret = slice_from_s(z, 2, s_69); /* <-, line 420 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Prefix_Step4_Verb(struct SN_env * z) { /* forwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 425 */
    z->bra = z->c; /* [, line 426 */
    if (z->c + 5 >= z->l || z->p[z->c + 5] != 170) return 0; /* substring, line 426 */
    among_var = find_among(z, a_9, 3);
    if (!(among_var)) return 0;
    z->ket = z->c; /* ], line 426 */
    switch (among_var) { /* among, line 426 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 427 */
            z->B[1] = 1; /* set is_verb, line 427 */
            z->B[0] = 0; /* unset is_noun, line 427 */
            {   int ret = slice_from_s(z, 6, s_70); /* <-, line 427 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Noun_Step1a(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 435 */
    z->ket = z->c; /* [, line 436 */
    among_var = find_among_b(z, a_10, 10); /* substring, line 436 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 436 */
    switch (among_var) { /* among, line 436 */
        case 0: return 0;
        case 1:
            ...
            break;
        case 2:
            if (!(z->I[0] >= 5)) return 0; /* $word_len >= <integer expression>, line 438 */
            {   int ret = slice_del(z); /* delete, line 438 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            if (!(z->I[0] >= 6)) return 0; /* $word_len >= <integer expression>, line 439 */
...
static int r_Suffix_Noun_Step1b(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 443 */
    z->ket = z->c; /* [, line 444 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 134) return 0; /* substring, line 444 */
    among_var = find_among_b(z, a_11, 1);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 444 */
    switch (among_var) { /* among, line 444 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 5)) return 0; /* $word_len > <integer expression>, line 445 */
            {   int ret = slice_del(z); /* delete, line 445 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Noun_Step2a(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 450 */
    z->ket = z->c; /* [, line 451 */
    among_var = find_among_b(z, a_12, 3); /* substring, line 451 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 451 */
    switch (among_var) { /* among, line 451 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] > 4)) return 0; /* $word_len > <integer expression>, line 452 */
            {   int ret = slice_del(z); /* delete, line 452 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Noun_Step2b(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 457 */
    z->ket = z->c; /* [, line 458 */
    if (z->c - 3 <= z->lb || z->p[z->c - 1] != 170) return 0; /* substring, line 458 */
    among_var = find_among_b(z, a_13, 1);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 458 */
    switch (among_var) { /* among, line 458 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 5)) return 0; /* $word_len >= <integer expression>, line 459 */
...
static int r_Suffix_Noun_Step2c1(struct SN_env * z) { /* backwardmode */
    ...
    z->ket = z->c; /* [, line 465 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 170) return 0; /* substring, line 465 */
    ...
    switch (among_var) { /* among, line 465 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 4)) return 0; /* $word_len >= <integer expression>, line 466 */
...
static int r_Suffix_Noun_Step2c2(struct SN_env * z) { /* backwardmode */
    ...
    z->ket = z->c; /* [, line 471 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 169) return 0; /* substring, line 471 */
...
static int r_Suffix_Noun_Step3(struct SN_env * z) { /* backwardmode */
    ...
    z->ket = z->c; /* [, line 477 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 138) return 0; /* substring, line 477 */
    ...
    switch (among_var) { /* among, line 477 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 3)) return 0; /* $word_len >= <integer expression>, line 478 */
...
static int r_Suffix_Verb_Step1(struct SN_env * z) { /* backwardmode */
    ...
    z->ket = z->c; /* [, line 484 */
    among_var = find_among_b(z, a_17, 12); /* substring, line 484 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 484 */
    switch (among_var) { /* among, line 484 */
        ...
        case 1:
            ...
            break;
        case 2:
            if (!(z->I[0] >= 5)) return 0; /* $word_len >= <integer expression>, line 486 */
            {   int ret = slice_del(z); /* delete, line 486 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            if (!(z->I[0] >= 6)) return 0; /* $word_len >= <integer expression>, line 487 */
            {   int ret = slice_del(z); /* delete, line 487 */
                if (ret < 0) return ret;
            }
            break;
    }
...
static int r_Suffix_Verb_Step2a(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 491 */
    z->ket = z->c; /* [, line 492 */
    among_var = find_among_b(z, a_18, 11); /* substring, line 492 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 492 */
    switch (among_var) { /* among, line 492 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 4)) return 0; /* $word_len >= <integer expression>, line 493 */
            {   int ret = slice_del(z); /* delete, line 493 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            if (!(z->I[0] >= 4)) return 0; /* $word_len >= <integer expression>, line 494 */
            {   int ret = slice_del(z); /* delete, line 494 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            if (!(z->I[0] >= 5)) return 0; /* $word_len >= <integer expression>, line 495 */
            {   int ret = slice_del(z); /* delete, line 495 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            if (!(z->I[0] > 5)) return 0; /* $word_len > <integer expression>, line 496 */
            {   int ret = slice_del(z); /* delete, line 496 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            if (!(z->I[0] >= 6)) return 0; /* $word_len >= <integer expression>, line 497 */
...
static int r_Suffix_Verb_Step2b(struct SN_env * z) { /* backwardmode */
    ...
    z->ket = z->c; /* [, line 503 */
    if (z->c - 3 <= z->lb || (z->p[z->c - 1] != 133 && z->p[z->c - 1] != 167)) return 0; /* substring, line 503 */
    ...
    switch (among_var) { /* among, line 503 */
        case 0: return 0;
        case 1:
            if (!(z->I[0] >= 5)) return 0; /* $word_len >= <integer expression>, line 504 */
...
static int r_Suffix_Verb_Step2c(struct SN_env * z) { /* backwardmode */
    ...
    z->ket = z->c; /* [, line 511 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 136) return 0; /* substring, line 511 */
    ...
    switch (among_var) { /* among, line 511 */
        ...
        case 1:
            ...
            break;
        case 2:
            if (!(z->I[0] >= 6)) return 0; /* $word_len >= <integer expression>, line 513 */
...
static int r_Suffix_All_alef_maqsura(struct SN_env * z) { /* backwardmode */
    int among_var;
    z->I[0] = len_utf8(z->p); /* $word_len = <integer expression>, line 518 */
    z->ket = z->c; /* [, line 519 */
    if (z->c - 1 <= z->lb || z->p[z->c - 1] != 137) return 0; /* substring, line 519 */
    among_var = find_among_b(z, a_21, 1);
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 519 */
    switch (among_var) { /* among, line 519 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(z, 2, s_71); /* <-, line 520 */
                if (ret < 0) return ret;
            }
            break;
    }
...
extern int arabic_UTF_8_stem(struct SN_env * z) { /* forwardmode */
    z->B[0] = 1; /* set is_noun, line 529 */
    z->B[1] = 1; /* set is_verb, line 530 */
    z->B[2] = 0; /* unset is_defined, line 531 */
    {   int c1 = z->c; /* do, line 534 */
        {   int ret = r_Checks1(z); /* call Checks1, line 534 */
            if (ret == 0) goto lab0;
            if (ret < 0) return ret;
        }
    lab0:
    ...
    {   int c2 = z->c; /* do, line 537 */
        {   int ret = r_Normalize_pre(z); /* call Normalize_pre, line 537 */
            if (ret == 0) goto lab1;
            if (ret < 0) return ret;
        }
    lab1:
    ...
    z->lb = z->c; z->c = z->l; /* backwards, line 540 */

    {   int m3 = z->l - z->c; (void)m3; /* do, line 542 */
        {   int m4 = z->l - z->c; (void)m4; /* or, line 556 */
            if (!(z->B[1])) goto lab4; /* Boolean test is_verb, line 545 */
            {   int m5 = z->l - z->c; (void)m5; /* or, line 551 */
                {   int i = 1;
                    while(1) { /* atleast, line 548 */
                        int m6 = z->l - z->c; (void)m6;
                        {   int ret = r_Suffix_Verb_Step1(z); /* call Suffix_Verb_Step1, line 548 */
                            if (ret == 0) goto lab7;
                            if (ret < 0) return ret;
                        }
                        i--;
                ...
                {   int m7 = z->l - z->c; (void)m7; /* or, line 549 */
                    {   int ret = r_Suffix_Verb_Step2a(z); /* call Suffix_Verb_Step2a, line 549 */
                        if (ret == 0) goto lab9;
                        if (ret < 0) return ret;
                    }
                    goto lab8;
                lab9:
                    z->c = z->l - m7;
                    {   int ret = r_Suffix_Verb_Step2c(z); /* call Suffix_Verb_Step2c, line 549 */
                        if (ret == 0) goto lab10;
                        if (ret < 0) return ret;
                    }
                    goto lab8;
            ...
            lab6:
                z->c = z->l - m5;
                {   int ret = r_Suffix_Verb_Step2b(z); /* call Suffix_Verb_Step2b, line 551 */
                    if (ret == 0) goto lab11;
                    if (ret < 0) return ret;
                }
                goto lab5;
            lab11:
                z->c = z->l - m5;
                {   int ret = r_Suffix_Verb_Step2a(z); /* call Suffix_Verb_Step2a, line 552 */
                    if (ret == 0) goto lab4;
                    if (ret < 0) return ret;
                }
            }
        ...
        lab4:
            z->c = z->l - m4;
            if (!(z->B[0])) goto lab12; /* Boolean test is_noun, line 557 */
            {   int m8 = z->l - z->c; (void)m8; /* try, line 560 */
                {   int m9 = z->l - z->c; (void)m9; /* or, line 562 */
                    {   int ret = r_Suffix_Noun_Step2c2(z); /* call Suffix_Noun_Step2c2, line 561 */
                        if (ret == 0) goto lab15;
                        if (ret < 0) return ret;
                    }
                    goto lab14;
                lab15:
                    z->c = z->l - m9;
                    /* not, line 562 */
                    if (!(z->B[2])) goto lab17; /* Boolean test is_defined, line 562 */
                    goto lab16;
                lab17:
                    {   int ret = r_Suffix_Noun_Step1a(z); /* call Suffix_Noun_Step1a, line 562 */
                        if (ret == 0) goto lab16;
                        if (ret < 0) return ret;
                    }
                    {   int m10 = z->l - z->c; (void)m10; /* or, line 564 */
                        {   int ret = r_Suffix_Noun_Step2a(z); /* call Suffix_Noun_Step2a, line 563 */
                            if (ret == 0) goto lab19;
                            if (ret < 0) return ret;
                        }
                        goto lab18;
                    lab19:
                        z->c = z->l - m10;
                        {   int ret = r_Suffix_Noun_Step2b(z); /* call Suffix_Noun_Step2b, line 564 */
                            if (ret == 0) goto lab20;
                            if (ret < 0) return ret;
                        }
                        goto lab18;
                    lab20:
                        z->c = z->l - m10;
                        {   int ret = r_Suffix_Noun_Step2c1(z); /* call Suffix_Noun_Step2c1, line 565 */
                            if (ret == 0) goto lab21;
                            if (ret < 0) return ret;
                        }
                        goto lab18;
                ...
                lab16:
                    z->c = z->l - m9;
                    {   int ret = r_Suffix_Noun_Step1b(z); /* call Suffix_Noun_Step1b, line 567 */
                        if (ret == 0) goto lab22;
                        if (ret < 0) return ret;
                    }
                    {   int m11 = z->l - z->c; (void)m11; /* or, line 569 */
                        {   int ret = r_Suffix_Noun_Step2a(z); /* call Suffix_Noun_Step2a, line 568 */
                            if (ret == 0) goto lab24;
                            if (ret < 0) return ret;
                        }
                        goto lab23;
                    lab24:
                        z->c = z->l - m11;
                        {   int ret = r_Suffix_Noun_Step2b(z); /* call Suffix_Noun_Step2b, line 569 */
                            if (ret == 0) goto lab25;
                            if (ret < 0) return ret;
                        }
                        goto lab23;
                    lab25:
                        z->c = z->l - m11;
                        {   int ret = r_Suffix_Noun_Step2c1(z); /* call Suffix_Noun_Step2c1, line 570 */
                            if (ret == 0) goto lab22;
                            if (ret < 0) return ret;
                        }
                    }
                ...
                lab22:
                    z->c = z->l - m9;
                    /* not, line 571 */
                    if (!(z->B[2])) goto lab27; /* Boolean test is_defined, line 571 */
                    goto lab26;
                lab27:
                    {   int ret = r_Suffix_Noun_Step2a(z); /* call Suffix_Noun_Step2a, line 571 */
                        if (ret == 0) goto lab26;
                        if (ret < 0) return ret;
                    }
                    goto lab14;
                lab26:
                    z->c = z->l - m9;
                    {   int ret = r_Suffix_Noun_Step2b(z); /* call Suffix_Noun_Step2b, line 572 */
            ...
            {   int ret = r_Suffix_Noun_Step3(z); /* call Suffix_Noun_Step3, line 574 */
                if (ret == 0) goto lab12;
                if (ret < 0) return ret;
            }
            goto lab3;
        lab12:
            z->c = z->l - m4;
            {   int ret = r_Suffix_All_alef_maqsura(z); /* call Suffix_All_alef_maqsura, line 580 */
                if (ret == 0) goto lab2;
                if (ret < 0) return ret;
            }
        }
    ...
    z->c = z->lb;
    {   int c12 = z->c; /* do, line 585 */
        {   int c13 = z->c; /* try, line 586 */
            {   int ret = r_Prefix_Step1(z); /* call Prefix_Step1, line 586 */
        ...
        {   int c14 = z->c; /* try, line 587 */
            {   int ret = r_Prefix_Step2(z); /* call Prefix_Step2, line 587 */
        ...
        {   int c15 = z->c; /* or, line 589 */
            {   int ret = r_Prefix_Step3a_Noun(z); /* call Prefix_Step3a_Noun, line 588 */
                if (ret == 0) goto lab32;
                if (ret < 0) return ret;
            }
            goto lab31;
        lab32:
            z->c = c15;
            if (!(z->B[0])) goto lab33; /* Boolean test is_noun, line 589 */
            {   int ret = r_Prefix_Step3b_Noun(z); /* call Prefix_Step3b_Noun, line 589 */
                if (ret == 0) goto lab33;
                if (ret < 0) return ret;
            }
            goto lab31;
        lab33:
            z->c = c15;
            if (!(z->B[1])) goto lab28; /* Boolean test is_verb, line 590 */
            {   int c16 = z->c; /* try, line 590 */
                {   int ret = r_Prefix_Step3_Verb(z); /* call Prefix_Step3_Verb, line 590 */
            ...
            {   int ret = r_Prefix_Step4_Verb(z); /* call Prefix_Step4_Verb, line 590 */
                if (ret == 0) goto lab28;
                if (ret < 0) return ret;
            }
        }
    ...
    {   int c17 = z->c; /* do, line 595 */
        {   int ret = r_Normalize_post(z); /* call Normalize_post, line 595 */
            if (ret == 0) goto lab35;
            if (ret < 0) return ret;
        }
    lab35:
