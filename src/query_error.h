...
#define QUERY_XERRS(X)                                                                           \
  ...
  X(QUERY_EHYBRID_VSIM_FILTER_INVALID_QUERY, "Vector queries are not allowed in VSIM filter")    \
  X(QUERY_EHYBRID_VSIM_FILTER_INVALID_WEIGHT, "Weight attribute is not allowed in VSIM filter")  \
  X(QUERY_EHYBRID_SEARCH_INVALID_QUERY, "Vector queries are not allowed in HYBRID SEARCH")       \
