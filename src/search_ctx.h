...
typedef enum { RS_CTX_UNSET, RS_CTX_READONLY, RS_CTX_READWRITE } RSContextFlags;
...
typedef struct RedisSearchCtx {
    ...
    unsigned int
        apiVersion; // API Version to allow for backward compatibility / alternative functionality
