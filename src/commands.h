...
#define RS_RULEADD RS_CMD_PREFIX ".RULEADD"
#define RS_RULESET RS_CMD_PREFIX ".RULESET"

#define RS_SCANSTART_CMD RS_CMD_PREFIX ".SCANSTART"
#define RS_QUEUEITEMS_CMD RS_CMD_PREFIX ".QUEUEITEMS"
