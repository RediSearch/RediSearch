...
#define RS_DELETE_CMD RS_CMD_WRITE_PREFIX ".DELETE"
#define RS_DROP_IF_X_CMD RS_CMD_WRITE_PREFIX "._DROPIFX" // for replica of support
#define RS_DELETE_IF_X_CMD RS_CMD_WRITE_PREFIX "._DELETEIFX" // for replica of support
#define RS_SYNADD_CMD RS_CMD_WRITE_PREFIX ".SYNADD"
#define RS_SYNUPDATE_CMD RS_CMD_WRITE_PREFIX ".SYNUPDATE"
#define RS_SYNFORCEUPDATE_CMD RS_CMD_WRITE_PREFIX ".SYNFORCEUPDATE"
