...
ResultProcessor *RPQueryIterator_New(QueryIterator *itr, const SharedSlotRangeArray *slotRanges, const RedisModuleSlotRangeArray *slotRanges_, uint32_t slotsVersion, RedisSearchCtx *sctx);
