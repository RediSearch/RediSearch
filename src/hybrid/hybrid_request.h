...
static inline QueryTimeoutStage HybridRequest_TimeoutStage(HybridRequest *req) {
...
static inline void HybridRequest_SetTimeoutStage(HybridRequest *req, QueryTimeoutStage stage) {
