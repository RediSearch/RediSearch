...
int RediSearch_InitModuleInternal(RedisModuleCtx *ctx) {
  ...
  if (SearchDisk_IsEnabled()) {
    ...
    RSGlobalConfig.gcConfigParams.gcSettings.forkGcRunIntervalSec = DEFAULT_DISK_GC_RUN_INTERVAL;
    RSGlobalConfig.gcConfigParams.gcSettings.forkGcCleanThreshold = DEFAULT_DISK_GC_CLEAN_THRESHOLD;
