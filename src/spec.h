...
// ASM_PROPAGATE definitions shipped while INDEX_CURRENT_VERSION was 25; Setting to INDEX_VECSIM_SVS_VAMANA_VERSION raises a warning
#define INDEX_ASM_PROPAGATE_DEFINITIONS_VERSION 25
