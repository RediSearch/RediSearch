...
#define SPEC_SEPARATORS_STR "SEPARATORS"
...
typedef enum {
  ...
  Index_HasCustomSeparators = 0x80000,
} IndexFlags;
...
#define INDEX_SEPARATORS_VERSION 24
...
typedef struct IndexSpec {
  ...
  SeparatorList *separators;      // Separator character list
