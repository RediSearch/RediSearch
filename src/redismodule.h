...
#define REDISMODULE_BIG_CALLBACKS_VERSION 3
...
typedef struct RedisModuleBigCallbacksV3 {
  uint64_t version;
  size_t (*getDiskUsage)(void);
  size_t (*getCachedDiskUsage)(void);
...
} RedisModuleBigCallbacksV3;

#define RedisModuleBigCallbacks RedisModuleBigCallbacksV3
