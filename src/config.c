...
int set_min_operation_workers(const char *set_min_operation_workers,
                      long long val, void *privdata, RedisModuleString **err) {
  RSGlobalConfig.minOperationWorkers = (size_t)val;
  // Will only change the number of workers if we are in an event,
  // and `numWorkerThreads` is less than `minOperationWorkers`.
  workersThreadPool_SetNumWorkers();
  return REDISMODULE_OK;
...
// vss-max-resize
int set_vss_max_resize(const char *set_vss_max_resize, long long val,
                       void *privdata, RedisModuleString **err) {
  RSGlobalConfig.vssMaxResize = (unsigned int)val;
  return REDISMODULE_OK;
}
...
// multi-text-slop
int set_multi_text_slop(const char *set_multi_text_slop, long long val,
                        void *privdata, RedisModuleString **err) {
  RSGlobalConfig.multiTextOffsetDelta = (unsigned int)val;
  return REDISMODULE_OK;
}
...
// bg-index-sleep-gap
int set_bg_index_sleep_gap(const char *set_bg_index_sleep_gap, long long val,
                           void *privdata, RedisModuleString **err) {
  RSGlobalConfig.numBGIndexingIterationsBeforeSleep = (unsigned int) val;
  return REDISMODULE_OK;
}
...
int RegisterModuleConfig(RedisModuleCtx *ctx) {
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        set_numeric_ranges_parents, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
      ...
      UINT32_MAX, get_bg_index_sleep_gap, set_bg_index_sleep_gap,
  ...
  if (RedisModule_RegisterNumericConfig (
        ...
        get_fork_gc_clean_threshold, set_fork_gc_clean_threshold, NULL,
  ...
  if (RedisModule_RegisterNumericConfig (
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 1, LLONG_MAX,
        get_fork_gc_retry_interval, set_fork_gc_retry_interval, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 1, LLONG_MAX,
        get_fork_gc_run_interval, set_fork_gc_run_interval, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        get_fork_gc_sleep_before_exit, set_fork_gc_sleep_before_exit, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 0,
        LLONG_MAX, get_index_cursor_limit, set_index_cursor_limit, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 0,
        LLONG_MAX, get_max_aggregate_results, set_max_aggregate_results, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 1, LLONG_MAX,
        get_max_prefix_expansions, set_max_prefix_expansions, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_IMMUTABLE | REDISMODULE_CONFIG_UNPREFIXED, 1,
        MAX_DOC_TABLE_SIZE, get_max_doctablesize, set_max_doctablesize, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 1, LLONG_MAX,
        get_cursor_max_idle, set_cursor_max_idle, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 0, LLONG_MAX,
        get_max_search_results, set_max_search_results, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        MAX_WORKER_THREADS, get_min_operation_workers, set_min_operation_workers,
        NULL, NULL) == REDISMODULE_ERR) {
    return REDISMODULE_ERR;
  }
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 1, LLONG_MAX,
        get_min_phonetic_term_len, set_min_phonetic_term_len, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 1, LLONG_MAX,
        get_min_prefix, set_min_prefix, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        UINT32_MAX, get_min_stem_len, set_min_stem_len, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_IMMUTABLE | REDISMODULE_CONFIG_UNPREFIXED, 1,
        UINT32_MAX, get_multi_text_slop, set_multi_text_slop, NULL, NULL) == REDISMODULE_ERR) {
    return REDISMODULE_ERR;
  }
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        LLONG_MAX, get_tiered_hnsw_buffer_limit, set_tiered_hnsw_buffer_limit, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 1,
        LLONG_MAX, get_timeout, set_timeout, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 1,
        LLONG_MAX, get_union_iterator_heap, set_union_iterator_heap, NULL,
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        REDISMODULE_CONFIG_DEFAULT | REDISMODULE_CONFIG_UNPREFIXED, 0,
        UINT32_MAX, get_vss_max_resize, set_vss_max_resize, NULL, NULL) == REDISMODULE_ERR) {
    return REDISMODULE_ERR;
  }
  ...
  if (RedisModule_RegisterNumericConfig(
        ...
        set_workers_priority_bias_threshold, NULL,
