...
def testTradSimp(env):
    ...
    env.assertContains(b'<b>\xe9\x82\xa3\xe6\x99\x82</b>\xef... ', res[2])
    env.assertContains(b'<b>\xe9\x82\xa3\xe6\x97\xb6</b>\xef... ', res[4])
    ...
    env.assertTrue('那時'.encode('utf-8') in res1[b'txt'])
    env.assertTrue('那时'.encode('utf-8') in res2[b'txt'])
