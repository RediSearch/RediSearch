...
def testSanitySearchJsonWithin(env):
    ...
    conn.execute_command(
        ...
        "small",
        "$",
        '{"geom": "POLYGON((34.9001 29.7001, 34.9001 29.7100, 34.9100 29.7100, 34.9100 29.7001, 34.9001 29.7001))"}',
    )
    conn.execute_command(
        "JSON.SET",
        "large",
        "$",
        '{"geom": "POLYGON((34.9001 29.7001, 34.9001 29.7200, 34.9200 29.7200, 34.9200 29.7001, 34.9001 29.7001))"}',
    )
    expected = [
        "$",
        '[{"geom":"POLYGON((34.9001 29.7001, 34.9001 29.7100, 34.9100 29.7100, 34.9100 29.7001, 34.9001 29.7001))"}]',
    ...
    env.expect(
        ...
        2,
        "poly",
        "POLYGON((34.9000 29.7000, 34.9000 29.7150, 34.9150 29.7150, 34.9150 29.7000, 34.9000 29.7000))",
        "DIALECT",
        3,
    ).equal([1, "small", expected])
    ...
    env.expect(
        ...
        "DIALECT",
        3,
    ).equal([1, "small", ["geom", json.dumps([json.loads(expected[1])[0]["geom"]])]])
    res = env.cmd(
        "FT.SEARCH",
        "idx",
        "@geom:[within $poly]",
        ...
        2,
        "poly",
        "POLYGON((34.9000 29.7000, 34.9000 29.7250, 34.9250 29.7250, 34.9250 29.7000, 34.9000 29.7000))",
        "NOCONTENT",
        "DIALECT",
        3,
    )
...
def testSanitySearchJsonCombined(env):
    conn = getConnectionByEnv(env)
    env.expect(
        "FT.CREATE idx ON JSON SCHEMA $.geom AS geom GEOSHAPE $.name as name TEXT"
    ).ok()
    ...
    conn.execute_command(
        ...
        "p1",
        "$",
        '{"geom": "POLYGON((34.9001 29.7001, 34.9001 29.7100, 34.9100 29.7100, 34.9100 29.7001, 34.9001 29.7001))", "name": "Homer"}',
    )
    conn.execute_command(
        "JSON.SET",
        "p2",
        "$",
        '{"geom": "POLYGON((34.9001 29.7001, 34.9001 29.7100, 34.9090 29.7090, 34.9100 29.7001, 34.9001 29.7001))", "name": "Bart"}',
    )
    env.expect(
        "FT.SEARCH",
        "idx",
        "@name:(Ho*) @geom:[within $poly]",
        "PARAMS",
        2,
        "poly",
        "POLYGON((34.9000 29.7000, 34.9000 29.7150, 34.9150 29.7150, 34.9150 29.7000, 34.9000 29.7000))",
...
def test_MOD_7126(env):
    ...
    triangle = (
        "POLYGON((34.9020 29.720, 34.9025 29.735, 34.9035 29.725, 34.9020 29.720))"
    )
...
def testWKTIngestError(env):
    ...
    conn.execute_command(
        ...
        "p1",
        "$",
        '{"geom": "POLIKON((34.9001 29.7001, 34.9001 29.7100, 34.9100 29.7100, 34.9100 29.7001, 34.9001 29.7001))", "name": "Homer"}',
    )
    # Missing parenthesis
    conn.execute_command(
        "JSON.SET",
        "p2",
        "$",
        '{"geom": "POLYGON(34.9001 29.7001, 34.9001 29.7100, 34.9100 29.7100, 34.9100 29.7001, 34.9001 29.7001))", "name": "Patty"}',
    )
    ...
    conn.execute_command(
        ...
        "p6",
        "$",
        '{"geom": "POLYGON((34.9001 29.7001, 34.9001 29.7100, 34.9001 29.7001))", "name": "Milhouse"}',
    )
    # Zero coordinates
    conn.execute_command(
        "JSON.SET", "p7", "$", '{"geom": "POLYGON(()())", "name": "Mr. Burns"}'
    )
    ...
    conn.execute_command(
        ...
        "p3",
        "$",
        '{"geom": "POLYGON((34.9001 29.7001, 001 , 34.9100 29.7100, 34.9100 29.7001, 34.9001 29.7001))", "name": "Moe"}',
    )
    ...
    conn.execute_command(
        ...
        "p4",
        "$",
        '{"geom": "POLYGON((34.9001 29.7001, 34.9001 29.7100 34.9100 29.7100, 34.9100 29.7001, 34.9001 29.7001))", "name": "Seymour"}',
    )
    ...
    conn.execute_command(
        ...
        "p5",
        "$",
        '{"geom": "POLYGON((34.9001 29.71 34.91 29.7100, 34.9100 29.7100, 34.9100 29.7001, 34.9001 29.7001))", "name": "Ned"}',
    )
...
def testWKTQueryError(env):
    ...
    env.expect(
        "FT.SEARCH",
        "idx",
        "@name:(Ho*) @geom:[within POLYGON((34.9000 29.7000, 34.9000 29.7150, 34.9150 29.7150, 34.9150 29.7000, 34.9000 29.7000))]",
        "NOCONTENT",
        "DIALECT",
        3,
    ).error().contains("Syntax error")
    env.expect(
        "FT.SEARCH", "idx", "@name:(Ho*) @geom:[within $]", "NOCONTENT", "DIALECT", 3
    ).error().contains("Syntax error")
    env.expect(
        "FT.SEARCH", "idx", "@name:(Ho*) @geom:[within poly]", "NOCONTENT", "DIALECT", 3
    ).error().contains("Syntax error")
    # Bad Polygon
    env.expect(
        "FT.SEARCH",
        ...
        2,
        "poly",
        "POLIGON((34.9000 29.7000, 34.9000 29.7150, 34.9150 29.7150, 34.9150 29.7000, 34.9000 29.7000))",
        "NOCONTENT",
        "DIALECT",
        3,
    ).error()
    ...
    env.expect(
        ...
        2,
        "poly",
        "POLIGON((34.9000 29.7000, a 150, 34.9150 29.7150, 34.9150 29.7000, 34.9000 29.7000))",
        "NOCONTENT",
        "DIALECT",
        3,
    ).error()
    ...
    env.expect(
        ...
        "DIALECT",
        3,
    ).error().contains("No such parameter")
    env.expect(
        "FT.SEARCH",
        "idx",
        "@name:(Ho*) @geom:[within $poly]",
...
def testSimpleUpdate(env):
    ...
    conn = getConnectionByEnv(env)
    env.expect(
        "FT.CREATE", "idx", "SCHEMA", "geom", "GEOSHAPE", "geom2", "GEOSHAPE"
    ).ok()
    conn.execute_command(
        "HSET",
        "k1",
        "geom",
        "POLYGON((34.9001 29.7001, 34.9001 29.7100, 34.9100 29.7100, 34.9100 29.7001, 34.9001 29.7001))",
    )
    conn.execute_command(
        "HSET",
        "k2",
        "geom",
        "POLYGON((34.9001 29.7001, 34.9001 29.7200, 34.9200 29.7200, 34.9200 29.7001, 34.9001 29.7001))",
    )
    conn.execute_command(
        "HSET",
        "k3",
        ...
        "POLYGON((34.9001 29.7001, 34.9001 29.7200, 34.9200 29.7200, 34.9200 29.7001, 34.9001 29.7001))",
        "geom2",
        "POLYGON((34.9001 29.7001, 34.9001 29.7140, 34.9140 29.7140, 34.9140 29.7001, 34.9001 29.7001))",
    )
    ...
    expected2 = [
        "geom",
        "POLYGON((34.9001 29.7001, 34.9001 29.7120, 34.9120 29.7120, 34.9120 29.7001, 34.9001 29.7001))",
    ]
    expected3 = [
        "geom",
        "POLYGON((34.9001 29.7001, 34.9001 29.7200, 34.9200 29.7200, 34.9200 29.7001, 34.9001 29.7001))",
    ...
    env.assertEqual(
        sortResultByKeyName(res),
        sortResultByKeyName([2, "k1", expected1, "k2", expected2]),
    )
    ...
    res = env.cmd(
        ...
        2,
        "poly",
        "POLYGON((34.9005 29.7005, 34.9005 29.7150, 34.9150 29.7150, 34.9150 29.7005, 34.9005 29.7005))",
        "DIALECT",
        3,
    )
    ...
    env.expect(
        ...
        2,
        "poly",
        "POLYGON((34.9002 29.7002, 34.9002 29.7150, 34.9150 29.7150, 34.9150 29.7002, 34.9002 29.7002))",
        "DIALECT",
        3,
    ).equal([1, "k3", expected3])
...
def testFieldUpdate(env):
    ...
    conn = getConnectionByEnv(env)
    env.expect(
        "FT.CREATE", "idx", "SCHEMA", "geom1", "GEOSHAPE", "geom2", "GEOSHAPE"
    ).ok()
    field1 = [
        "geom1",
        "POLYGON((34.9001 29.7001, 34.9001 29.7200, 34.9200 29.7200, 34.9200 29.7001, 34.9001 29.7001))",
    ...
    env.assertEqual(
        sortResultByKeyName(res), sortResultByKeyName([1, "k1", [*field1, *field2]])
    )
    ...
    res = env.cmd(
        ...
        2,
        "poly",
        "POLYGON((34.9000 29.7000, 34.9000 29.7170, 34.9170 29.7170, 34.9170 29.7000, 34.9000 29.7000))",
        "DIALECT",
        3,
    )
    env.assertEqual(
    ...
    field2 = [
        "geom2",
        "POLYGON((34.9001 29.7001, 34.9001 29.7180, 34.9180 29.7180, 34.9180 29.7001, 34.9001 29.7001))",
    ]
    conn.execute_command("HSET", "k1", *field2)
    # Search contains on geom field
    res = env.cmd(
    ...
    env.expect(
        ...
        2,
        "poly",
        "POLYGON((34.9001 29.7001, 34.9001 29.7170, 34.9170 29.7170, 34.9170 29.7001, 34.9001 29.7001))",
        "DIALECT",
        3,
    ).equal([0])
    ...
    field1 = [
        "geom1",
        "POLYGON((34.9001 29.7001, 34.9001 29.7149, 34.9149 29.7149, 34.9149 29.7001, 34.9001 29.7001))",
    ]
    ...
    env.expect(
        ...
        2,
        "poly",
        "POLYGON((34.9001 29.7001, 34.9001 29.7150, 34.9150 29.7150, 34.9150 29.7001, 34.9001 29.7001))",
        "DIALECT",
        3,
    ).equal([0])
    # Search within on geom2 field
...
def testFtInfo(env):
    ...
    cur_usage = float(
        res[info_key_name]
    )  # index is not lazily built. even an empty index consumes some memory
    ...
    conn.execute_command(
        ...
        "doc1",
        "txt",
        "Not a real POLYGON((34.9001 29.7001, 34.9001 29.7100, 34.9100 29.7100, 34.9100 29.7001, 34.9001 29.7001))",
    )
    res = to_dict(env.cmd("FT.INFO idx1"))
    ...
    for i in range(1, doc_num + 1):
        conn.execute_command(
            ...
            f"doc{i}",
            "geom",
            f"POLYGON(({0.02*i} {0.02*i}, {0.02*i} {1+0.02*i}, {1+0.02*i} {1+0.02*i}, {1+0.02*i} {0.02*i}, {0.02*i} {0.02*i}))",
        )
