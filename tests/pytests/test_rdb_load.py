...
import signal
import tempfile
from common import skip, getRDBFile, REDISEARCH_CACHE_DIR, config_cmd, debug_cmd, getConnectionByEnv, waitForIndex, waitForRdbSaveToFinish
...
def test_rdb_load_no_deadlock():
    ...
    in_progress = waitForRdbSaveToFinish(lambda: test_env.cmd('INFO', 'persistence'))
