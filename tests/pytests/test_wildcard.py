...
def testSanity(env):
    ...
    for i in range(1):
        ...
        env.expect('ft.search', index_list[i], "w'f?*'", 'LIMIT', 0 , 0).equal([40000])
        env.expect('ft.search', index_list[i], "w'fo?o*'", 'LIMIT', 0 , 0).equal([20000])
        env.expect('ft.search', index_list[i], "w'fo?o1*'", 'LIMIT', 0 , 0).equal([1111])
        env.expect('ft.search', index_list[i], "w'*ooo???1*'", 'LIMIT', 0 , 0).equal([2700])

        # contains
        env.expect('ft.search', index_list[i], "w'*oo*'", 'LIMIT', 0 , 0).equal([40000])
        env.expect('ft.search', index_list[i], "w'*o?o*'", 'LIMIT', 0 , 0).equal([30000])
        env.expect('ft.search', index_list[i], "w'*o??o*'", 'LIMIT', 0 , 0).equal([20000])
        env.expect('ft.search', index_list[i], "w'?*o??o*?'", 'LIMIT', 0 , 0).equal([20000])
        # 55xx & x55x & xx55 - 555x - x555 
        env.expect('ft.search', index_list[i], "w'*55*'", 'LIMIT', 0 , 0).equal([1120])
        env.expect('ft.search', index_list[i], "w'*5?5*'", 'LIMIT', 0 , 0).equal([796])
        env.expect('ft.search', index_list[i], "w'*5??5*'", 'LIMIT', 0 , 0).equal([400])
        env.expect('ft.search', index_list[i], "w'?*5??5*?'", 'LIMIT', 0 , 0).equal([0])
        # 555x & x555 - 5555
        ...
        env.expect('ft.search', index_list[i], "w'*55?5*'", 'LIMIT', 0 , 0).equal([40])
        env.expect('ft.search', index_list[i], "w'*o?55*'", 'LIMIT', 0 , 0).equal([696])
        env.expect('ft.search', index_list[i], "w'*oo?55*?'", 'LIMIT', 0 , 0).equal([470])
        env.expect('ft.search', index_list[i], "w'*oo?555*'", 'LIMIT', 0 , 0).equal([47])
        env.expect('ft.search', index_list[i], "w'*oo55?5*'", 'LIMIT', 0 , 0).equal([30])
        env.expect('ft.search', index_list[i], "w'*oo?555?*'", 'LIMIT', 0 , 0).equal([20])
