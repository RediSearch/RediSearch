...
def testProfileVector(env):
  ...
  expected_iterators_res = ['Iterators profile', ['Type', 'VECTOR', 'Counter', 2L]]
  ...
  expected_iterators_res = ['Iterators profile', ['Type', 'VECTOR', 'Counter', 2L, 'Child iterator', ['Type', 'INTERSECT', 'Counter', 0L, 'Child iterators', ['Type', 'TEXT', 'Term', 'world', 'Counter', 0L, 'Size', 2L], ['Type', 'TEXT', 'Term', 'hello', 'Counter', 0L, 'Size', 5L]]]]
  env.assertEqual(actual_res[1][3], expected_iterators_res)
  env.assertEqual(actual_res[1][4][3], expected_vecsim_rp_res)
