...
def testProfileVector(env):
  ...
  expected_iterators_res = ['Iterators profile', ['Type', 'VECTOR', 'Counter', 2, 'Child iterator', ['Type', 'INTERSECT', 'Counter', 4, 'Child iterators', ['Type', 'TEXT', 'Term', 'world', 'Counter', 4, 'Size', 2], ['Type', 'TEXT', 'Term', 'hello', 'Counter', 4, 'Size', 5]]]]
