...
def testFailedHighlight(env):
    ...
    env.assertEqual([1, 'doc1', ['f1', 'foo foo foo', 'f2', 'bar bar bar', 'f3', 'baz baz baz']],
        env.cmd('ft.search idx foo'))
    env.assertEqual([1, 'doc1', ['f1', '<b>foo</b> <b>foo</b> <b>foo</b>', 'f2', 'bar bar bar', 'f3', 'baz baz baz']],
        env.cmd('ft.search', 'idx', 'foo', 'highlight', 'fields', '1', 'f1'))
    env.assertEqual([1, 'doc1', ['f2', 'bar bar bar', 'f1', 'foo foo foo', 'f3', 'baz baz baz']],
        env.cmd('ft.search idx foo highlight fields 1 f2'))
    env.assertEqual([1, 'doc1', ['f3', 'baz baz baz', 'f1', 'foo foo foo', 'f2', 'bar bar bar']],
    ...
    env.assertEqual([1, 'doc2', ['f1', '<b>foo</b> <b>foo</b> <b>foo</b>', 'f2', '', 'f3', 'baz baz baz']],
        env.cmd('ft.search idx2 foo highlight fields 1 f1'))
    env.assertEqual([1, 'doc2', ['f2', '', 'f1', 'foo foo foo', 'f3', 'baz baz baz']],
        env.cmd('ft.search idx2 foo highlight fields 1 f2'))
    env.assertEqual([1, 'doc2', ['f3', 'baz baz baz', 'f1', 'foo foo foo', 'f2', '']],
    ...
    env.assertEqual([1, 'doc3', ['f1', '<b>foo</b> <b>foo</b> <b>foo</b>', 'f2', 'not a', 'f3', 'baz baz baz']],
        env.cmd('ft.search idx3 foo highlight fields 1 f1'))
    env.assertEqual([1, 'doc3', ['f2', 'not a', 'f1', 'foo foo foo', 'f3', 'baz baz baz']],
        env.cmd('ft.search idx3 foo highlight fields 1 f2'))
    env.assertEqual([1, 'doc3', ['f3', 'baz baz baz', 'f1', 'foo foo foo', 'f2', 'not a']],
