...
def test_vector(env):
    ...
    env.assertEqual(res2[1:], res1)
    res2 = conn.execute_command('FT.SEARCH', 'idx', '*=>[TOP_K 2 @v $vec AS v_score]', 'PARAMS', '4', 'vec', 'aaaaaaaa', 'k', '2', *args) 
    env.assertEqual(res2[1:], res1)
    res2 = conn.execute_command('FT.SEARCH', 'idx', '*=>[TOP_K 2 @v $vec AS $score]', 'PARAMS', '6', 'vec', 'aaaaaaaa', 'k', '2', 'score', 'v_score', *args) 
    env.assertEqual(res2[1:], res1)
