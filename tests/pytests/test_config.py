...
def testSetConfigOptionsErrors(env):
    ...
    # Test BG_INDEX_SLEEP_DURATION_US validation (max 999999 due to usleep POSIX limit)
    env.expect(config_cmd(), 'set', 'BG_INDEX_SLEEP_DURATION_US', 1000000).contains('BG_INDEX_SLEEP_DURATION_US must be between 0 and 999999')
...
numericConfigs = [
    ...
    ('search-bg-index-sleep-duration-us', 'BG_INDEX_SLEEP_DURATION_US', 1, 0, 999999, False, False),
