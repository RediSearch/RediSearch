...
def testGetConfigOptions(env):
    ...
    if MT_BUILD:
        ...
        check_config('PRIORITY_BIAS_NUM')
...
def testAllConfig(env):
    ...
    if MT_BUILD:
        ...
        env.assertEqual(res_dict['PRIORITY_BIAS_NUM'][0], '1')
...
def testInitConfig():
    ...
    if MT_BUILD:
        ...
        test_arg_num('PRIORITY_BIAS_NUM', 4)
...
def testImmutable(env):
    ...
    if MT_BUILD:
        ...
        env.expect('ft.config', 'set', 'PRIORITY_BIAS_NUM').error().contains(not_modifiable)
