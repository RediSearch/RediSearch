...
def testGetConfigOptions(env):
    ...
    check_config('BM25STD_TANH_STRETCH')
...
def testSetConfigOptions(env):
    ...
    env.expect(config_cmd(), 'set', 'BM25STD_TANH_STRETCH', 1).equal('OK')
...
def testSetConfigOptionsErrors(env):
    ...
    env.expect(config_cmd(), 'set', 'BM25STD_TANH_STRETCH', -1).contains('Value is outside acceptable bounds')
    env.expect(config_cmd(), 'set', 'BM25STD_TANH_STRETCH', 10001).contains('BM25STD_TANH_STRETCH must be between 1 and 10000')
...
def testAllConfig(env):
    ...
    env.assertEqual(res_dict['BM25STD_TANH_STRETCH'][0], '4')
...
def testInitConfig():
    ...
    _test_config_num('BM25STD_TANH_STRETCH', 4)
...
numericConfigs = [
    ...
    ('search-bm25std-tanh-stretch', 'BM25STD_TANH_STRETCH', 4, 1, 10000, False, False),
    # Cluster parameters
