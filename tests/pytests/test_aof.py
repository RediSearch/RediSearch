...
def aofTestCommon(env, reloadfn):
    ...
    for x in range(1, 10):
        conn.execute_command(
            "hset", "doc{}".format(x), "field1", "myText{}".format(x), "field2", 20 * x
        )
    ...
    exp = [
        9,
        "doc1",
        ["field1", "myText1", "field2", "20"],
        "doc2",
        ["field1", "myText2", "field2", "40"],
        "doc3",
        ["field1", "myText3", "field2", "60"],
        "doc4",
        ["field1", "myText4", "field2", "80"],
        "doc5",
        ["field1", "myText5", "field2", "100"],
        "doc6",
        ["field1", "myText6", "field2", "120"],
        "doc7",
        ["field1", "myText7", "field2", "140"],
        "doc8",
        ["field1", "myText8", "field2", "160"],
        "doc9",
...
def testAofRewriteTags():
    ...
    env.assertEqual([2, "1", "$a", ["foo", "A"], "2", "$b", ["foo", "B"]], res)
