...
def testOptimizer(env):
	...
	env.expect('ft.search', 'idx', '*', 'limit', 0 , 3, 'NOCONTENT').equal([3, '0', '1', '2'])
	env.expect('ft.search', 'idx_sortable', '*', 'limit', 0 , 1, 'NOCONTENT').equal([1, '0'])
	env.expect('ft.search', 'idx_sortable', '*', 'limit', 0 , 3, 'NOCONTENT').equal([3, '0', '1', '2'])
	...
	env.expect('ft.search', 'idx', '@n:[10 20]', 'limit', 0 , 3, 'NOCONTENT').equal([3, '10', '11', '12'])
	env.expect('ft.search', 'idx_sortable', '@n:[10 20]', 'limit', 0 , 1, 'NOCONTENT').equal([1, '10'])
	env.expect('ft.search', 'idx_sortable', '@n:[10 20]', 'limit', 0 , 3, 'NOCONTENT').equal([3, '10', '11', '12'])
	...
	env.expect('ft.search', 'idx', '@tag:{foo}', 'limit', 0 , 3, 'NOCONTENT').equal([3, '0', '2', '4'])
	env.expect('ft.search', 'idx_sortable', '@tag:{foo}', 'limit', 0 , 1, 'NOCONTENT').equal([1, '0'])
	env.expect('ft.search', 'idx_sortable', '@tag:{foo}', 'limit', 0 , 3, 'NOCONTENT').equal([3, '0', '2', '4'])
