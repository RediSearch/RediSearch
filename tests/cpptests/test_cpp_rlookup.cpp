...
TEST_F(RLookupTest, testAddKeysFromBasic) {
  RLookup source = RLookup_New_Stack(), dest = RLookup_New_Stack();
...
TEST_F(RLookupTest, testAddKeysFromMultipleAdditions) {
  RLookup src1 = RLookup_New_Stack(), src2 = RLookup_New_Stack(), src3 = RLookup_New_Stack(), dest = RLookup_New_Stack();
...
TEST_F(RLookupTest, testMultipleSourcesNoOverlap) {
  RLookup src1 = RLookup_New_Stack(), src2 = RLookup_New_Stack(), dest = RLookup_New_Stack();
  RLookup_Init(&src1, NULL);
  RLookup_Init(&src2, NULL);
  RLookup_Init(&dest, NULL);
