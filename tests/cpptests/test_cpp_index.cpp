...
TEST_F(IndexTest, testUnion) {
  ...
  for (int cfg = 0; cfg < 2; ++cfg) {
    ...
    IndexIterator *ui = NewUnionIterator(irs, 2, NULL, 0, 1, QN_UNION, NULL, &MAX_TIMESPEC);
    RSIndexResult *h = NULL;
...
TEST_F(IndexTest, testWeight) {
  ...
  IndexIterator *ui = NewUnionIterator(irs, 2, NULL, 0, 0.8, QN_UNION, NULL, &MAX_TIMESPEC);
  RSIndexResult *h = NULL;
