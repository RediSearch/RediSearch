...
TEST_F(LLApiTest, testInfo) {
  ...
  ASSERT_EQ(info.invertedSize, 808);
...
TEST_F(LLApiTest, testInfoSize) {
  ...
  EXPECT_EQ(RediSearch_MemUsage(index), 366 + additional_overhead);
  ...
  EXPECT_EQ(RediSearch_MemUsage(index), 667 + additional_overhead);
...
TEST_F(LLApiTest, testInfoSizeWithExistingIndex) {
  ...
  EXPECT_EQ(RediSearch_MemUsage(index), 470 + additional_overhead);
  ...
  EXPECT_EQ(RediSearch_MemUsage(index), 771 + additional_overhead);
