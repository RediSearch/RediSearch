...
TEST_F(LLApiTest, testInfo) {
  ...
  ASSERT_STREQ(RediSearch_HiddenNameGet(info.fields[0].path), "ft1");
  ...
  ASSERT_STREQ(RediSearch_HiddenNameGet(info.fields[1].path), "ft2");
  ASSERT_TRUE(info.fields[1].options & RSFLDOPT_TXTNOSTEM);
  ASSERT_EQ(info.fields[1].types, RSFLDTYPE_FULLTEXT);

  ASSERT_STREQ(RediSearch_HiddenNameGet(info.fields[2].path), "n1");
  ...
  ASSERT_STREQ(RediSearch_HiddenNameGet(info.fields[3].path), "tg1");
  ...
  ASSERT_STREQ(RediSearch_HiddenNameGet(info.fields[4].path), "dynamic1");
