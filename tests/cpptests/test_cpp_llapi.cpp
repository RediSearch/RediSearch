...
TEST_F(LLApiTest, testInfoSizeWithExistingIndex) {
  ...
  // Print the doc_table_size and the base size of the numeric range tree
  printf("doc_table_size: %zu\n", doc_table_size);
  printf("NumericRangeTree_BaseSize: %zu\n", NumericRangeTree_BaseSize());
