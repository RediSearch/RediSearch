...
TEST_F(LLApiTest, testInfo) {
  ...
  ASSERT_STREQ(RediSearch_HiddenStringGet(info.fields[0].path, false), "ft1");
  ...
  ASSERT_STREQ(RediSearch_HiddenStringGet(info.fields[1].path, false), "ft2");
  ASSERT_TRUE(info.fields[1].options & RSFLDOPT_TXTNOSTEM);
  ASSERT_EQ(info.fields[1].types, RSFLDTYPE_FULLTEXT);

  ASSERT_STREQ(RediSearch_HiddenStringGet(info.fields[2].path, false), "n1");
  ...
  ASSERT_STREQ(RediSearch_HiddenStringGet(info.fields[3].path, false), "tg1");
  ...
  ASSERT_STREQ(RediSearch_HiddenStringGet(info.fields[4].path, false), "dynamic1");
