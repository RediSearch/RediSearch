...
size_t RMCK::GetRefcount(const RedisModuleString *s) { return s->refcount; }
...
void RMCK::flushdb(RedisModuleCtx *ctx) { ctx->db->clear(); }
...
void RMCK::init() { RMCK_Bootstrap(my_OnLoad, NULL, 0); }
