...
public:
    ...
    int typecode() const { return m_typecode; }
...
public:
    ...
    const std::map<std::string, std::string> &items() const { return m_map; }
...
public:
    ...
    virtual size_t size() override { return m_list.size(); }
...
public:
    std::string m_string;
    virtual size_t size() override { return m_string.size(); }
...
struct KVDB {
    ...
    Value *get(RedisModuleString *s) { return get(*s); }
...
struct RedisModuleCtx {
    ...
    void notifyRemoved(RedisModuleKey *k) { allockeys.erase(k); }

    void notifyRemoved(RedisModuleString *s) { allocstrs.erase(s); }
