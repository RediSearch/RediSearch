...
TEST_F(AggTest, testGroupBy) {
  ...
  ctx.rkscore = RLookup_GetKey_TEMP(&rk_in, "score", RLOOKUP_F_OCREAT);
  ctx.rkvalue = RLookup_GetKey_TEMP(&rk_in, "value", RLOOKUP_F_OCREAT);
  ...
  RLookup rk_out = {0};
  RLookupKey *v_out = RLookup_GetKey_TEMP(&rk_out, "value", RLOOKUP_F_OCREAT);
  RLookupKey *score_out = RLookup_GetKey_TEMP(&rk_out, "SCORE", RLOOKUP_F_OCREAT);
  RLookupKey *count_out = RLookup_GetKey_TEMP(&rk_out, "COUNT", RLOOKUP_F_OCREAT);
...
TEST_F(AggTest, testGroupSplit) {
  ...
  RLookup lk_in = {0};
  RLookup lk_out = {0};
  gen.kvalue = RLookup_GetKey_TEMP(&lk_in, "value", RLOOKUP_F_OCREAT);
  RLookupKey *val_out = RLookup_GetKey_TEMP(&lk_out, "value", RLOOKUP_F_OCREAT);
  RLookupKey *count_out = RLookup_GetKey_TEMP(&lk_out, "COUNT", RLOOKUP_F_OCREAT);
