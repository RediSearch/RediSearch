...
TEST_F(AggTest, testBasic) {
    ...
    RMCK::ArgvList args(ctx, "FT.CREATE", "idx", "ON", "HASH", "SCHEMA", "t1", "TEXT", "SORTABLE",
                        "t2", "NUMERIC", "sortable", "t3", "TEXT");
...
public:
    ...
    RPMock() { memset(this, 0, sizeof(*this)); }
};
...
public:
    ...
    ArrayGenerator() { memset(static_cast<ResultProcessor *>(this), 0, sizeof(ResultProcessor)); }
};
