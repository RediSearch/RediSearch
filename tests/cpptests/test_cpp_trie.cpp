...
static bool trieInsert(Trie *t, const char *s) { return trieInsert(t, s, strlen(s)); }
static bool trieInsert(Trie *t, const std::string &s) { return trieInsert(t, s.c_str(), s.size()); }
...
static ElemSet trieIterRange(Trie *t, const char *begin, size_t nbegin, const char *end,
    ...
    TrieNode_IterateRange(t->root, r1Ptr, nr1, true, r2Ptr, nr2, false, rangeFunc, &foundElements);
