...
then
    ...
    $MODE yum install -y wget git devtoolset-11-gcc devtoolset-11-gcc-c++ \
        devtoolset-11-make rsync unzip libclang-dev clang jq
    ...
    $MODE yum install -y wget git devtoolset-10-gcc devtoolset-10-gcc-c++ \
        devtoolset-10-make rsync unzip clang curl libclang-dev jq
