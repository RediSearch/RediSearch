...
### General
Invoke [/swamp-implement-task](.skills/swamp-implement-task/SKILL.md) to take a port, bug fix, or feature from task description to a green pull request. It drives the swamp workflows that sequence the phases and enforce the gates between them.
