 ...
 * Please check if it is safe to start a data collecting process by calling redisearch_thpool_StateLog_test_and_start()
 ...
 * NOTE: The flag is turned off by redisearch_thpool_StateLog_done().
*/
