...
<!-- DO NOT MERGE: perf-fixture/null-control. This comment is the entire change. It
     exists so this branch is a distinct commit -- and therefore a distinct
     RedisTimeSeries series -- from perf-fixture/baseline while compiling to an
     identical binary. See PERF-GATE-FIXTURES.md. -->
