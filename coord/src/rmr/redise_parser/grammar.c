...
**                       token.
**    MRTopologyRequest_ParseTOKENTYPE     is the data type used for minor type for terminal
...
**                       which is MRTopologyRequest_ParseTOKENTYPE.  The entry in the union
**                       for terminal symbols is called "yy0".
**    YYSTACKDEPTH       is the maximum depth of the parser's stack.  If
**                       zero the stack is dynamically sized using realloc()
**    MRTopologyRequest_ParseARG_SDECL     A static variable declaration for the %extra_argument
**    MRTopologyRequest_ParseARG_PDECL     A parameter declaration for the %extra_argument
**    MRTopologyRequest_ParseARG_PARAM     Code to pass %extra_argument as a subroutine parameter
**    MRTopologyRequest_ParseARG_STORE     Code to store %extra_argument into yypParser
**    MRTopologyRequest_ParseARG_FETCH     Code to extract %extra_argument from yypParser
**    MRTopologyRequest_ParseCTX_*         As MRTopologyRequest_ParseARG_ except for %extra_context
...
#define MRTopologyRequest_ParseTOKENTYPE Token
typedef union {
  int yyinit;
  MRTopologyRequest_ParseTOKENTYPE yy0;
  char * yy9;
  MREndpoint yy17;
  int yy20;
  RLShard yy25;
  MRClusterTopology * yy41;
} YYMINORTYPE;
#ifndef YYSTACKDEPTH
#define YYSTACKDEPTH 100
#endif
#define MRTopologyRequest_ParseARG_SDECL  parseCtx *ctx ;
#define MRTopologyRequest_ParseARG_PDECL , parseCtx *ctx 
#define MRTopologyRequest_ParseARG_PARAM ,ctx 
#define MRTopologyRequest_ParseARG_FETCH  parseCtx *ctx =yypParser->ctx ;
#define MRTopologyRequest_ParseARG_STORE yypParser->ctx =ctx ;
#define MRTopologyRequest_ParseCTX_SDECL
#define MRTopologyRequest_ParseCTX_PDECL
#define MRTopologyRequest_ParseCTX_PARAM
#define MRTopologyRequest_ParseCTX_FETCH
#define MRTopologyRequest_ParseCTX_STORE
#define YYNSTATE             17
#define YYNRULE              16
...
#endif
  MRTopologyRequest_ParseARG_SDECL                /* A place to hold %extra_argument */
  MRTopologyRequest_ParseCTX_SDECL                /* A place to hold %extra_context */
#if YYSTACKDEPTH<=0
...
static const char *const yyRuleName[] = {
 ...
 /*   3 */ "cluster ::= cluster HASREPLICATION",
 /*   4 */ "topology ::= RANGES INTEGER",
 /*   5 */ "topology ::= topology shard",
 /*   6 */ "shard ::= SHARD shardid SLOTRANGE INTEGER INTEGER endpoint master",
 /*   7 */ "shardid ::= STRING",
 /*   8 */ "shardid ::= INTEGER",
 /*   9 */ "endpoint ::= tcp_addr",
 /*  10 */ "endpoint ::= tcp_addr unix_addr",
 /*  11 */ "tcp_addr ::= ADDR STRING",
 /*  12 */ "unix_addr ::= UNIXADDR STRING",
 /*  13 */ "master ::= MASTER",
 /*  14 */ "master ::=",
 /*  15 */ "cluster ::=",
};
...
** second argument to MRTopologyRequest_ParseAlloc() below.  This can be changed by
...
*/
void MRTopologyRequest_ParseInit(void *yypRawParser MRTopologyRequest_ParseCTX_PDECL){
...
#ifndef MRTopologyRequest_Parse_ENGINEALWAYSONSTACK
/* 
...
** to MRTopologyRequest_Parse and MRTopologyRequest_ParseFree.
*/
void *MRTopologyRequest_ParseAlloc(void *(*mallocProc)(YYMALLOCARGTYPE) MRTopologyRequest_ParseCTX_PDECL){
  yyParser *yypParser;
  yypParser = (yyParser*)(*mallocProc)( (YYMALLOCARGTYPE)sizeof(yyParser) );
  if( yypParser ){
    MRTopologyRequest_ParseCTX_STORE
    MRTopologyRequest_ParseInit(yypParser MRTopologyRequest_ParseCTX_PARAM);
  }
  return (void*)yypParser;
}
#endif /* MRTopologyRequest_Parse_ENGINEALWAYSONSTACK */
...
static void yy_destructor(
  ...
  MRTopologyRequest_ParseARG_FETCH
  MRTopologyRequest_ParseCTX_FETCH
  switch( yymajor ){
    ...
    case 21: /* unix_addr */
{
 rm_free((yypminor->yy9)); 
    ...
    case 13: /* shard */
{
 MRClusterNode_Free(&(yypminor->yy25).node); 
}
      break;
    case 14: /* endpoint */
{
 MREndpoint_Free(&(yypminor->yy17)); 
}
      break;
    case 15: /* topology */
{
 MRClusterTopology_Free((yypminor->yy41)); 
}
      break;
    case 16: /* master */
{
...
*/
#if defined(YYCOVERAGE)
int MRTopologyRequest_ParseCoverage(FILE *out){
...
/******** End %stack_overflow code ********************************************/
   MRTopologyRequest_ParseARG_STORE /* Suppress warning about unused %extra_argument var */
   MRTopologyRequest_ParseCTX_STORE
}
...
static void yy_shift(
  ...
  MRTopologyRequest_ParseTOKENTYPE yyMinor        /* The minor token to shift in */
){
  yyStackEntry *yytos;
  yypParser->yytos++;
#ifdef YYTRACKMAXSTACKDEPTH
...
static const signed char yyRuleInfoNRhs[] = {
   -2,  /* (0) root ::= cluster topology */
   -3,  /* (1) cluster ::= cluster MYID shardid */
   -5,  /* (2) cluster ::= cluster HASHFUNC STRING NUMSLOTS INTEGER */
   -2,  /* (3) cluster ::= cluster HASREPLICATION */
   -2,  /* (4) topology ::= RANGES INTEGER */
   -2,  /* (5) topology ::= topology shard */
   -7,  /* (6) shard ::= SHARD shardid SLOTRANGE INTEGER INTEGER endpoint master */
   -1,  /* (7) shardid ::= STRING */
   -1,  /* (8) shardid ::= INTEGER */
   -1,  /* (9) endpoint ::= tcp_addr */
   -2,  /* (10) endpoint ::= tcp_addr unix_addr */
   -2,  /* (11) tcp_addr ::= ADDR STRING */
   -2,  /* (12) unix_addr ::= UNIXADDR STRING */
   -1,  /* (13) master ::= MASTER */
    0,  /* (14) master ::= */
    0,  /* (15) cluster ::= */
};
...
static YYACTIONTYPE yy_reduce(
  ...
  MRTopologyRequest_ParseTOKENTYPE yyLookaheadToken  /* Value of the lookahead token */
  MRTopologyRequest_ParseCTX_PDECL                   /* %extra_context */
){
...
{  yy_destructor(yypParser,17,&yymsp[-1].minor);
{
    ...
    // CRC12 / 4096
    yymsp[0].minor.yy41->hashFunc = MRHashFunc_None;
    if (ctx->shardFunc) {
        if (!strncasecmp(ctx->shardFunc, MRHASHFUNC_CRC12_STR, strlen(MRHASHFUNC_CRC12_STR))) {
            yymsp[0].minor.yy41->hashFunc = MRHashFunc_CRC12;
...
err:
   if (ctx->ok == 0) {
        MRClusterTopology_Free(yymsp[0].minor.yy41);
   }
}
}
        break;
...
{
    MRTopology_AddRLShard(yymsp[-1].minor.yy41, &yymsp[0].minor.yy25);
      ...
      case 6: /* shard ::= SHARD shardid SLOTRANGE INTEGER INTEGER endpoint master */
{
    yymsp[-6].minor.yy25 = (RLShard){
            .node = (MRClusterNode) {
            .id = yymsp[-5].minor.yy9,
            .flags = MRNode_Coordinator | (yymsp[0].minor.yy20 ? MRNode_Master : 0),
            .endpoint = yymsp[-1].minor.yy17,
        },
      ...
      case 7: /* shardid ::= STRING */
{
  ...
  yymsp[0].minor.yy9 = yylhsminor.yy9;
        break;
      case 8: /* shardid ::= INTEGER */
{
	__ignore__(rm_asprintf(&yylhsminor.yy9, "%lld", yymsp[0].minor.yy0.intval));
}
  yymsp[0].minor.yy9 = yylhsminor.yy9;
        break;
      ...
      case 14: /* master ::= */
{
    yymsp[1].minor.yy20 = 0;
        ...
        break;
      default:
      /* (15) cluster ::= */ yytestcase(yyruleno==15);
        break;
/********** End reduce actions ************************************************/
  };
...
static void yy_syntax_error(
  ...
  MRTopologyRequest_ParseTOKENTYPE yyminor         /* The minor type of the error token */
){
  MRTopologyRequest_ParseARG_FETCH
  MRTopologyRequest_ParseCTX_FETCH
...
** "MRTopologyRequest_ParseAlloc" which describes the current state of the parser.
...
void MRTopologyRequest_Parse(
  ...
  MRTopologyRequest_ParseTOKENTYPE yyminor       /* The value for the token */
  MRTopologyRequest_ParseARG_PDECL               /* Optional %extra_argument parameter */
){
  ...
  MRTopologyRequest_ParseCTX_FETCH
  MRTopologyRequest_ParseARG_STORE
  ...
  while(1){ /* Exit by "break" */
    ...
    if( yyact >= YY_MIN_REDUCE ){
      ...
      ** enough on the stack to push the LHS value */
      ...
      yyact = yy_reduce(yypParser,yyruleno,yymajor,yyminor MRTopologyRequest_ParseCTX_PARAM);
...
*/
int MRTopologyRequest_ParseFallback(int iToken){
#ifdef YYFALLBACK
