...
CCVER:=$(shell $(READIES)/bin/ccver -c $(CC))
CMAKE_COMPILER=-DCMAKE_CC_COMPILER=$(CC) -DCMAKE_CXX_COMPILER=$(CXX) -DCCVER=$(CCVER)

CMAKE_FLAGS += $(CMAKE_ARGS) $(CMAKE_COMPILER) $(CMAKE_DEBUG) $(CMAKE_STATIC) $(CMAKE_COORD) $(CMAKE_COV) \
